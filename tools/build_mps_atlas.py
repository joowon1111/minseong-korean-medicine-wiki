...
def forearm_base(front=False):
 return p('M64 30 Q120 6 176 30 L160 258 L157 275 L164 322 L78 322 L83 273 L65 178 Z','skin')+p('M88 46 L102 258 M157 45 L136 258','bone')+p('M82 269 L157 269','line')+t(93,7,'팔꿈치',13)+t(172,274,'손목',12)+t(9,144,'노쪽',12)+t(185,144,'자쪽',12)
def jaw_base():
