...
- For Huangdi Neijing, Zhenjiu Jiayi Jing and Zhenjiu Dacheng, expand only selected material useful for current clinical assessment, anatomy, treatment research or practical self-care. Do not force comprehensive coverage or classical explanations onto modern care. Continue Dongyi Suse Bowon within its own Sasang framework.
