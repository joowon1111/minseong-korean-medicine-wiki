...
이는 평소 이악물기로 생기는 저작근 통증과 구분해야 합니다. 시력 변화가 있으면 즉시 응급평가를 연결하고, 결과에 맞춰 한의치료의 시점과 목표를 조정합니다. [ACR/Vasculitis Foundation 지침](https://pubmed.ncbi.nlm.nih.gov/34235884/)은 진단검사와 치료를 빠르게 연결하는 관리 원칙을 제시합니다.
