...
현재 [임상 심화 카드](../sasang-formula-cards/index.md)는 태음인 9종·소양인 8종·소음인 8종·태양인 2종, 총 27종입니다. 나머지 라이브러리 문서는 확인된 출전·구성·용량을 보존하며, 임상 감별 자료가 충분한 것부터 같은 형식으로 확장합니다.

## 체질·병증군으로 찾기

| 체질 | 병증군 | 대표·수록 처방 |
|---|---|---|
| 소양인 | [망음·표병](soyangin-exterior.md) | 형방지황탕·활석고삼탕·형방도백산·형방패독산 |
| 소양인 | [흉격열·리열](soyangin-interior-heat.md) | 양격산화탕·현삼백호탕·황련청장탕 |
| 소양인 | [음허오열·하소](soyangin-yin-deficiency.md) | 독활지황탕·숙지황고삼탕·화석지황탕 |
| 소양인 | [기타 주요 처방](soyangin-other.md) | 소양인 확장 처방과 비교 경로 |
| 태음인 | [위완수한표한](taeeumin-exterior-cold.md) | 태음조위탕·조위승청탕·행인승청탕·마황정통탕 등 |
| 태음인 | [간수열리열](taeeumin-interior-heat.md) | 열다한소탕·청폐사간탕·청심연자탕·갈근계 처방 등 |
| 태음인 | [기타 주요 처방](taeeumin-other.md) | 갈근해기탕·갈근승기탕 비교 |
| 소음인 | [태음병·리한](soeumin-taeeum.md) | 백하오이중탕·곽향정기산·관계부자이중탕 등 |
| 소음인 | [망양·표병](soeumin-mangyang.md) | 인삼계지부자탕·승양팔물탕·계지부자탕 |
| 소음인 | [비위·기체·기타](soeumin-digestive.md) | 향부자팔물탕·향소산·궁귀향소산 등 |
...
- **처방군 페이지**는 같은 체질 안에서 가까운 처방을 비교하는 지도입니다.
- **개별 라이브러리 문서**는 확인된 출전별 구성·용량·주치를 보존합니다. 동명 처방의 서로 다른 출전은 임의로 합치지 않습니다.
