---
title: 태극침법 주요 9경혈의 주치·효능
description: 소부·영도·소해·신문과 태연·태충·태계·태백·합곡의 경맥, 특정혈, 체질별 보사 역할 및 대표 주치를 361경혈 아틀라스로 연결합니다.
tags: [태극침법, 경혈, 주치, 효능, 오수혈, 원혈]
---
# 태극침법 주요 9경혈의 주치·효능

태극침법의 네 기본형에 등장하는 혈은 **심경 오수혈 4개와 다른 경맥의 원혈 5개, 총 9개**입니다. 각 경혈은 361경혈 문서와 같은 데이터·출처를 사용하며, 전통적 활용·진료지침 배혈·현대 연구를 나누어 읽을 수 있습니다. **신문·태연·태충·태계·태백·합곡 6혈**은 국내 연구진의 원문으로 교체했고, 소부·영도·소해는 기존 교육자료 출처를 유지합니다. 문헌상 주치와 임상시험에서 사용된 분야를 구분했으며, 경혈 사용 빈도는 치료 효과를 뜻하지 않습니다. [출처와 해석 범위](../portal/acupuncture.md#sources)를 확인하고, 위치·취혈 도해와 해부학적 안전은 혈명을 눌러 살펴보세요.

**심경혈:** [소부](#ht8) · [영도](#ht4) · [소해](#ht3) · [신문](#ht7)

**원혈:** [태연](#lu9) · [태충](#lr3) · [태계](#ki3) · [태백](#sp3) · [합곡](#li4)

## 혈자리별 역할과 임상 연결 {#profiles}

<!-- TAEGEUK_POINTS_START -->
### 소부 HT8 {#ht8}

**[위치·취혈 도해와 상세 주치](../acupuncture/points/ht8.md)**

| 항목 | 내용 |
|---|---|
| 소속 경맥 | [수소음심경 전체 주행](../meridian-network/heart-meridian.md) |
| 특정혈 | 형혈(滎)·화(火) |
| 태극침법 역할 | [태양인 보혈](constitutions.md#taeyangin) |

**전통적 효능·주치**

- **대표 주치·용도:** 두근거림 · 흉부 통증·답답함 [전통 주치·교육자료](https://www.americandragon.com/Points/HT-8.html)
- **효능·활용 방향:** 안신 — 긴장·수면 불편을 조절; 청열 — 열 양상의 증상을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 소부 HT8](https://www.kmcric.com/database/acupoint/HT/HT8)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
**임상 평가:** 잠드는 시간·중간 각성·낮 기능과 두근거림의 발생 상황을 기록합니다. [평가 자료](../conditions/insomnia.md)

### 영도 HT4 {#ht4}

**[위치·취혈 도해와 상세 주치](../acupuncture/points/ht4.md)**

| 항목 | 내용 |
|---|---|
| 소속 경맥 | [수소음심경 전체 주행](../meridian-network/heart-meridian.md) |
| 특정혈 | 경혈(經)·금(金) |
| 태극침법 역할 | [태음인 보혈](constitutions.md#taeeumin) |

**전통적 효능·주치**

- **대표 주치·용도:** 흉부 통증·답답함 · 팔꿈치 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/HT-4.html)
- **효능·활용 방향:** 안신 — 긴장·수면 불편을 조절; 통경 — 경맥의 통증·불편을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 영도 HT4](https://www.kmcric.com/database/acupoint/HT/HT4)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
**임상 평가:** 흉부 증상의 원인 평가를 먼저 하고, 호흡·움직임·식사와의 관계를 구별해 기록합니다. [평가 자료](../acupuncture-integrated/safety.md)

### 소해 HT3 {#ht3}

**[위치·취혈 도해와 상세 주치](../acupuncture/points/ht3-shaohai.md)**

| 항목 | 내용 |
|---|---|
| 소속 경맥 | [수소음심경 전체 주행](../meridian-network/heart-meridian.md) |
| 특정혈 | 합혈(合)·수(水) |
| 태극침법 역할 | [소양인 보혈](constitutions.md#soyangin) |

**전통적 효능·주치**

- **대표 주치·용도:** 팔꿈치 통증 · 팔 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/HT-3.html)
- **효능·활용 방향:** 통경 — 경맥의 통증·불편을 조절; 안신 — 긴장·수면 불편을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 소해 HT3](https://www.kmcric.com/database/acupoint/HT/HT3)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
**임상 평가:** 쥐기·들기와 팔꿈치 굽힘·폄에서 통증이 재현되는지 확인합니다. [평가 자료](../clinical-anatomy/mps-forearm.md)

### 신문 HT7 {#ht7}

**[위치·취혈 도해와 상세 주치](../acupuncture/points/ht7-shenmen.md)**

| 항목 | 내용 |
|---|---|
| 소속 경맥 | [수소음심경 전체 주행](../meridian-network/heart-meridian.md) |
| 특정혈 | 수혈(輸)·토(土)·원혈 |
| 태극침법 역할 | [소음인 보혈](constitutions.md#soeumin) |

**전통적 효능·주치**

- **문헌에서 확인한 관련 부위:** 흉부 관련 증상 — 『침구경험방』 분석 [출처 1](https://pmc.ncbi.nlm.nih.gov/articles/PMC4619912/#sec3)

**현대 임상 활용**

- **불면장애 지침의 주요 혈위:** 성인 원발성 불면의 일반침치료에서 주요 혈위로 제시됩니다. [출처 2](https://nikom.or.kr/nckm/module/practiceGuide/view.do?guide_idx=164&menu_idx=14)

진료지침의 배혈에서 맡는 역할입니다. 단일혈의 독립적인 효과를 뜻하지 않습니다.

**현대 연구에서 다루어진 분야**

- **임상시험에서 사용된 분야:** 불면증 [출처 3](https://pmc.ncbi.nlm.nih.gov/articles/PMC7564320/#jcm-09-03027-t001)
...
**표준 정보:** [KMCRIC 신문 HT7](https://www.kmcric.com/database/acupoint/HT/HT7)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
**[위치·취혈 도해와 상세 주치](../acupuncture/points/lu9-taiyuan.md)**

| 항목 | 내용 |
|---|---|
| 소속 경맥 | [수태음폐경 전체 주행](../meridian-network/lung-meridian.md) |
| 특정혈 | 수혈(輸)·토(土)·원혈·팔회혈(맥회) |
| 태극침법 역할 | [태양인 사혈](constitutions.md#taeyangin) · [태음인 보혈](constitutions.md#taeeumin) |
...
**임상 평가:** 흉부 증상은 원인 평가를 먼저 하고, 상지 증상은 움직임·감각·근력과 함께 기록합니다. [평가 자료](../acupuncture-integrated/safety.md)

### 태충 LR3 {#lr3}

**[위치·취혈 도해와 상세 주치](../acupuncture/points/lr3-taichong.md)**

| 항목 | 내용 |
|---|---|
| 소속 경맥 | [족궐음간경 전체 주행](../meridian-network/liver-meridian.md) |
| 특정혈 | 수혈(輸)·토(土)·원혈 |
| 태극침법 역할 | [태양인 보혈](constitutions.md#taeyangin) · [태음인 사혈](constitutions.md#taeeumin) |
...
**임상 평가:** 증상이 나타나는 부위와 두통·월경 주기의 관계를 기록하고 원인을 평가합니다. [평가 자료](../conditions/headache.md)

### 태계 KI3 {#ki3}

**[위치·취혈 도해와 상세 주치](../acupuncture/points/ki3-taixi.md)**

| 항목 | 내용 |
|---|---|
| 소속 경맥 | [족소음신경 전체 주행](../meridian-network/kidney-meridian.md) |
| 특정혈 | 수혈(輸)·토(土)·원혈 |
| 태극침법 역할 | [소양인 보혈](constitutions.md#soyangin) |

**전통적 효능·주치**

- **문헌에서 확인한 관련 부위:** 복부 · 하지 · 인후 관련 증상 — 『침구경험방』 분석 [출처 1](https://pmc.ncbi.nlm.nih.gov/articles/PMC4619912/#sec3)

**현대 임상 활용**

- **불면장애 지침의 변증별 추가 혈위:** 음허화왕 변증에 추가하는 혈로 제시됩니다. 모든 불면 환자의 공통 배혈은 아닙니다. [출처 2](https://nikom.or.kr/nckm/module/practiceGuide/view.do?guide_idx=164&menu_idx=14)
...
**표준 정보:** [KMCRIC 태계 KI3](https://www.kmcric.com/database/acupoint/KI/KI3)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
**임상 평가:** 통증·부종·체중부하와 발목 안정성을 평가하고, 외상 후 골절 가능성과 보행 제한을 먼저 확인합니다. [평가 자료](../acupuncture-integrated/musculoskeletal.md)

### 태백 SP3 {#sp3}

**[위치·취혈 도해와 상세 주치](../acupuncture/points/sp3.md)**

| 항목 | 내용 |
|---|---|
| 소속 경맥 | [족태음비경 전체 주행](../meridian-network/spleen-meridian.md) |
| 특정혈 | 수혈(輸)·토(土)·원혈 |
| 태극침법 역할 | [소양인 사혈](constitutions.md#soyangin) · [소음인 보혈](constitutions.md#soeumin) |
...
**임상 평가:** 식사 전후 불편·섭취량·구역 빈도를 기록하고 소화기 원인 평가와 연결합니다. [평가 자료](../conditions/functional-dyspepsia.md)

### 합곡 LI4 {#li4}

**[위치·취혈 도해와 상세 주치](../acupuncture/points/li4-hegu.md)**

| 항목 | 내용 |
|---|---|
| 소속 경맥 | [수양명대장경 전체 주행](../meridian-network/large-intestine-meridian.md) |
| 특정혈 | 원혈·사총혈(면구); 오수혈에 포함되지 않음 |
| 태극침법 역할 | [소음인 사혈](constitutions.md#soeumin) |
...
태연·태충은 태양인과 태음인에서, 태백은 소양인과 소음인에서 보사 방향이 달라집니다. **단일혈의 주치 목록을 그 혈을 포함한 모든 처방의 효능으로 합산하지 않습니다.** 체질을 판단한 이유와 치료 목표를 [체질별 기본형](constitutions.md), [반응 관찰 기록](assessment.md#record)에 함께 남깁니다.

신문은 심경 오수혈이면서 원혈이고, 태연·태충·태계·태백은 음경의 수토혈과 원혈을 겸합니다. **합곡은 대장경 원혈이며 오수혈은 아닙니다.** 태극침법을 ‘오수혈만 사용하는 침법’으로 외우면 이 차이를 놓치게 됩니다. [오수혈 전체표](../meridian-network/special-points/five-shu.md) · [12원혈](../meridian-network/special-points/yuan-source.md).

## 위치에서 경맥 전체로 {#atlas}

각 혈의 아틀라스에는 그 혈이 강조되는 기존 위치 도해가 제공됩니다. 손·발의 가까운 혈도 근육·힘줄·혈관·신경과의 관계가 다르므로 도해와 취혈 설명을 함께 확인합니다. 경맥 링크를 누르면 첫 혈에서 마지막 혈까지의 주행 도해와 전체 혈 목록을 볼 수 있습니다.

[WHO 표준 361경혈 아틀라스](../acupoint-network/standard-atlas.md) · [경락·경맥 지식망](../meridian-network/index.md) · [태극침법 핵심 허브](index.md)
