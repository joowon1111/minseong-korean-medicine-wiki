---
title: 정명 BL1
description: 정명 BL1 표준 위치·취혈·임상 지식망
status: 검토완료
...
눈을 감고 눈동자를 반대편으로 돌린 상태에서, 안쪽눈구석에서 위안쪽으로 0.1寸 지점의 오목한 곳에서 취혈한다.
...
- **대표 주치·용도:** 눈 통증 · 눈물흘림 · 시야 흐림 [전통 주치·교육자료](https://www.americandragon.com/Points/UB-1.html)
- **효능·활용 방향:** 명목 — 눈 관련 증상을 다루는 방향; 청열 — 열 양상의 증상을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 정명 BL1](https://www.kmcric.com/database/acupoint/BL/BL1)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
