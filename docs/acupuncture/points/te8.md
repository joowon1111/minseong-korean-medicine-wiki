---
title: 삼양락 TE8
description: 삼양락 TE8 표준 위치·취혈·임상 지식망
status: 검토완료
...
陽池(TE4)와 팔꿈치 끝(tip of the elbow)을 연결하는 선에서 위쪽으로부터 2/3와 아래쪽으로부터 1/3이 되는 지점에서 취혈한다.
...
- 斜刺 0.8～1.5寸 (深刺時에는 郄門(PC4)을 향해 2～3寸 刺入)
