---
title: 청령 HT2
description: 청령 HT2 표준 위치·취혈·임상 지식망
status: 검토완료
...
팔꿈치를 굽히고 위팔을 외전했을 때, 極泉(HT1)과 少海(HT3)를 연결하는 선에서 위쪽으로부터 2/3, 아래쪽으로부터 1/3이 되는 지점에서 취혈한다.
...
- **대표 주치·용도:** 팔 통증 · 어깨 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/HT-2.html)
...
**표준 정보:** [KMCRIC 청령 HT2](https://www.kmcric.com/database/acupoint/HT/HT2)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
