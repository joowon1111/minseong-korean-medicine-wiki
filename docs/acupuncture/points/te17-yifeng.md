...
- **대표 주치·용도:** 이명 · 청력 저하 · 안면마비·입 비뚤어짐 [전통 주치·교육자료](https://www.americandragon.com/Points/SJ-17.html)
- **효능·활용 방향:** 이규 — 귀 관련 증상을 다루는 방향; 청열 — 열 양상의 증상을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 예풍 TE17](https://www.kmcric.com/database/acupoint/TE/TE17)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
이명·청력 변화의 발생 시점, 좌우와 동반 어지럼을 구분합니다. [평가 자료](../../acupuncture-integrated/by-symptom.md)
