---
title: 옥침 BL9
description: 옥침 BL9 표준 위치·취혈·임상 지식망
status: 검토완료
...
등세모근(trapezius muscle) 가쪽모서리를 지나는 수직선과 바깥뒤통수뼈융기 위모서리를 지나는 수평선이 만나는 지점에서 취혈한다.
...
- **대표 주치·용도:** 목 통증·뻣뻣함 · 두통 · 어지럼 [전통 주치·교육자료](https://www.americandragon.com/Points/UB-9.html)
- **효능·활용 방향:** 지통 — 통증을 완화하는 방향; 통비규 — 코의 막힘을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 옥침 BL9](https://www.kmcric.com/database/acupoint/BL/BL9)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
