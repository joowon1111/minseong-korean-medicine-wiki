---
title: 각손 TE20
description: 각손 TE20 표준 위치·취혈·임상 지식망
status: 검토완료
...
귓바퀴를 앞으로 접어 머리에 눌러 붙일 때, 귓바퀴끝이 머리에 닿는 지점에서 취혈한다.
...
- **대표 주치·용도:** 이명 · 청력 저하 · 목 통증·뻣뻣함 [전통 주치·교육자료](https://www.americandragon.com/Points/SJ-20.html)
...
**표준 정보:** [KMCRIC 각손 TE20](https://www.kmcric.com/database/acupoint/TE/TE20)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
