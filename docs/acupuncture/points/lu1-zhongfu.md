...
먼저 雲門(LU2)을 정한 후, 雲門(LU2)에서 아래쪽으로 1寸이 되는 지점에서 취혈한다.
...
- **대표 주치·용도:** 기침 · 숨참 · 흉부 통증·답답함 · 어깨 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/LU-1.html)
- **효능·활용 방향:** 선폐·지해 — 기침·호흡 불편을 조절; 화담 — 담 관련 증상을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 중부 LU1](https://www.kmcric.com/database/acupoint/LU/LU1)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
