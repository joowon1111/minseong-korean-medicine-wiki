---
title: 합곡 LI4
description: 합곡 LI4의 소화기·통증·감기 초기 증상 관련 전통 주치와 사관혈 배혈, 부산대 공동연구, 위치·취혈 및 안전을 출처와 함께 정리합니다.
...
| 대표 전통 주치 | 소화기 증상 조절 · 통증 완화 · 해열·감기 초기 증상 · 기혈 소통과 사관혈 배혈 |

## 대표 효능·주치와 국내 자료 {#전통적-임상-연결}

아래 네 가지는 국내 문헌에 정리된 **합곡의 대표적인 전통적 효능·주치**입니다. 현대 연구는 그 아래에서 실제 대상과 배혈, 비교 결과를 별도로 확인할 수 있습니다.
...
소화기 증상은 식사와의 관계·구토·배변 양상을, 통증은 부위·강도·기능 제한을, 감기 양상은 발열·인후 증상과 경과를 함께 평가합니다. 지속되는 심한 복통·구토나 고열은 원인 평가를 우선합니다. 임신·분만 관련 사용은 산과 진료의 맥락에서 판단합니다. [평가 자료](../../acupuncture-integrated/safety.md)
...
합곡 LI4는 **원혈**이라는 성격을 갖습니다. 따라서 경혈명을 단독으로 외우기보다 해당 경맥의 유주, 표리경, 오수혈·원락·하합혈·팔회혈·팔맥교회혈 등과 함께 이해합니다.

→ [특정혈 임상 지식망](../../meridian-network/special-points/index.md)

## 자주 연결하는 배혈

**열결 LU7·곡지 LI11·영향 LI20·[태충 LR3](lr3-taichong.md)**

사관혈은 **좌우 합곡 2혈 + 좌우 태충 2혈**의 조합입니다. 합곡과 태충을 함께 써 기혈 소통과 통증 조절을 도모하는 전통적 배혈이며, 증상·변증에 따라 국소혈과 다른 원위혈을 조합합니다. 치료 반응에 따라 자극량과 구성을 조정합니다. [문헌: 133·136쪽](https://koreascience.kr/article/JAKO199325552553741.pdf)
