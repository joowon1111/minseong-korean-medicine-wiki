---
title: 격수 BL17
description: 격수 BL17의 위치, 소속 경맥, 특정혈 분류, 전통 주치, 임상 배혈, 해부학·안전성과 연구 방향을 정리합니다.
...
至陽(GV9)과 膈關(BL46) 사이의 중점에서 취혈한다.
...
| 소속 | 족태양방광경 |
| 특정혈 | 팔회혈 중 혈회 |
| 위치 요약 | 제7흉추 극돌기 아래에서 가쪽 1.5촌 |
| 임상 연결 | 혈·어혈·흉배부 통증 |

## 위치와 취혈

제7흉추 극돌기 아래에서 가쪽 1.5촌를 기준으로 취혈합니다. 실제 임상에서는 체형 차이와 촉진, 뼈·근육·건·혈관·신경 등 해부학적 표지를 함께 확인합니다.
...
- **대표 주치·용도:** 딸꾹질 · 복부팽만 · 등 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/UB-17.html)
- **효능·활용 방향:** 보기 — 기허 양상의 회복을 보완; 안신 — 긴장·수면 불편을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 격수 BL17](https://www.kmcric.com/database/acupoint/BL/BL17)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
가려움의 강도·범위·야간 악화와 피부 상태를 비교합니다. [평가 자료](../../acupuncture-integrated/followup.md)
...
이 혈의 **팔회혈 중 혈회** 성격은 같은 경맥의 오수혈·원혈·락혈·극혈, 표리경 및 기경팔맥 관계와 함께 보면 더 잘 이해할 수 있습니다.

→ [특정혈 임상 지식망](../../meridian-network/special-points/index.md)

## 해부학과 안전

흉곽 위 부위이므로 깊은 자침을 피합니다.
