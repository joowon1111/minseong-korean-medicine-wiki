---
title: 질변 BL54
description: 질변 BL54 표준 위치·취혈·임상 지식망
status: 검토완료
...
엎드린 자세에서, 엉치뼈틈새(sacral hiatus)에서 가쪽으로 3寸에서 취혈한다.
...
- **대표 주치·용도:** 요통 · 좌골신경통 양상의 하지 통증 · 배뇨 불편 [전통 주치·교육자료](https://www.americandragon.com/Points/UB-54.html)
- **효능·활용 방향:** 치료 목표 — 요통의 완화와 좌골신경통 양상의 하지 통증의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 질변 BL54](https://www.kmcric.com/database/acupoint/BL/BL54)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
- 생식기질환 치료시는 내측을 향해 45°의 각도로 2～3寸 刺入

- 肛門疾患 치료시는 內下方으로 약 45°의 각도로 2～3寸 刺入
