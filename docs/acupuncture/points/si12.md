---
title: 병풍 SI12
description: 병풍 SI12 표준 위치·취혈·임상 지식망
status: 검토완료
...
- **대표 주치·용도:** 어깨 통증 · 견갑부 통증 · 손·팔 저림 [전통 주치·교육자료](https://www.americandragon.com/Points/SI-12.html)
- **효능·활용 방향:** 치료 목표 — 어깨 통증의 완화와 견갑부 통증의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 병풍 SI12](https://www.kmcric.com/database/acupoint/SI/SI12)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
