---
title: 부돌 LI18
description: 부돌 LI18 표준 위치·취혈·임상 지식망
status: 검토완료
...
人迎(ST9)과 같은 높이로, 남성의 경우 후두융기와도 같은 높이에서 취혈한다.
...
- **대표 주치·용도:** 쉰 목소리 · 목 건조감 · 천명·천식 증상 [전통 주치·교육자료](https://www.americandragon.com/Points/LI-18.html)
- **효능·활용 방향:** 치료 목표 — 쉰 목소리의 완화와 목 건조감의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 부돌 LI18](https://www.kmcric.com/database/acupoint/LI/LI18)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
