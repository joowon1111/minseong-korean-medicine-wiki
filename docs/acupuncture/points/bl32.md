...
- **대표 주치·용도:** 요통 · 배뇨 불편 · 월경통 [전통 주치·교육자료](https://www.americandragon.com/Points/UB-32.html)
- **효능·활용 방향:** 이요 — 허리의 통증·기능을 다루는 방향; 조경 — 월경 관련 증상을 조절
...
**표준 정보:** [KMCRIC 차료 BL32](https://www.kmcric.com/database/acupoint/BL/BL32)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
