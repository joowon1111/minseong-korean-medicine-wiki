---
title: 소해 SI8
description: 소해 SI8 표준 위치·취혈·임상 지식망
status: 검토완료
...
팔꿈치를 약간 굽혔을 때, 자신경고랑(groove for the ulnar nerve)에 해당하는 곳에서 취혈한다. 손가락으로 그곳을 두드리면 전기 통하는 느낌이 새끼손가락까지 전달된다.
...
- **대표 주치·용도:** 팔꿈치 통증 · 팔 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/SI-8.html)
- **효능·활용 방향:** 치료 목표 — 팔꿈치 통증의 완화와 팔 통증의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 소해 SI8](https://www.kmcric.com/database/acupoint/SI/SI8)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
**사암침법에서의 역할:** [소장승격 사혈](../../acupuncture-specific/saam-12-meridians.md#si)
