---
title: 관문 ST22
description: 관문 ST22 표준 위치·취혈·임상 지식망
status: 검토완료
...
- **대표 주치·용도:** 복부팽만 · 식욕 저하 · 복통 [전통 주치·교육자료](https://www.americandragon.com/Points/ST-22.html)
- **효능·활용 방향:** 조장 — 배변 기능을 조절; 지통 — 통증을 완화하는 방향

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 관문 ST22](https://www.kmcric.com/database/acupoint/ST/ST22)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
