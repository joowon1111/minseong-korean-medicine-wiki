---
title: 이간 LI2
description: 이간 LI2 표준 위치·취혈·임상 지식망
status: 검토완료
...
주먹을 가볍게 쥐고, 둘째 손허리손가락관절 노쪽의 먼 쪽 오목한 곳에 취혈한다.
...
- **대표 주치·용도:** 치통 · 인후 통증 · 눈 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/LI-2.html)
- **효능·활용 방향:** 치료 목표 — 치통의 완화와 인후 통증의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 이간 LI2](https://www.kmcric.com/database/acupoint/LI/LI2)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
**사암침법에서의 역할:** [대장승격 사혈](../../acupuncture-specific/saam-12-meridians.md#li)

<!-- ACUPOINT_CLINICAL_END -->

## 자침법·안전

- 直刺 0.2～0.3寸 (鍼尖을 노쪽에서 자쪽을 향해 刺入)
