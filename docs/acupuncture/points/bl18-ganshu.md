---
title: 간수 BL18
description: 간수 BL18의 위치, 소속 경맥, 특정혈 분류, 전통 주치, 임상 배혈, 해부학·안전성과 연구 방향을 정리합니다.
...
筋縮(GV8)과 魂門(BL47) 사이의 중점에서 취혈한다.
...
| 소속 | 족태양방광경 |
| 특정혈 | 간의 배수혈 |
| 위치 요약 | 제9흉추 극돌기 아래에서 가쪽 1.5촌 |
| 임상 연결 | 간울·흉협·근긴장·눈 관련 전통 연결 |

## 위치와 취혈

제9흉추 극돌기 아래에서 가쪽 1.5촌를 기준으로 취혈합니다. 실제 임상에서는 체형 차이와 촉진, 뼈·근육·건·혈관·신경 등 해부학적 표지를 함께 확인합니다.
...
- **대표 주치·용도:** 위완부 통증 · 복통 · 옆구리 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/UB-18.html)
- **효능·활용 방향:** 명목 — 눈 관련 증상을 다루는 방향; 양혈 — 혈허 양상을 보완

**현대 임상 활용**

- **불면장애 지침의 변증별 추가 혈위:** 간울화화 변증에 추가하는 혈로 제시됩니다. 모든 불면 환자의 공통 배혈은 아닙니다. [출처 1](https://nikom.or.kr/nckm/module/practiceGuide/view.do?guide_idx=164&menu_idx=14)
- **불면장애 지침의 변증별 추가 혈위:** 심담기허 변증에 추가하는 혈로 제시됩니다. 모든 불면 환자의 공통 배혈은 아닙니다. [출처 1](https://nikom.or.kr/nckm/module/practiceGuide/view.do?guide_idx=164&menu_idx=14)
...
**표준 정보:** [KMCRIC 간수 BL18](https://www.kmcric.com/database/acupoint/BL/BL18)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
이 혈의 **간의 배수혈** 성격은 같은 경맥의 오수혈·원혈·락혈·극혈, 표리경 및 기경팔맥 관계와 함께 보면 더 잘 이해할 수 있습니다.
