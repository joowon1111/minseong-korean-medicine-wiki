---
title: 여구 LR5
description: 여구 LR5 표준 위치·취혈·임상 지식망
status: 검토완료
...
- **대표 주치·용도:** 월경불순 · 복통 · 가려움 [전통 주치·교육자료](https://www.americandragon.com/Points/LIV-5.html)
- **효능·활용 방향:** 조경 — 월경 관련 증상을 조절; 청열 — 열 양상의 증상을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 여구 LR5](https://www.kmcric.com/database/acupoint/LR/LR5)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
월경 주기·통증 시점·출혈 양상과 임신 가능성을 확인해 배혈을 검토합니다. [평가 자료](../../acupuncture-integrated/by-symptom.md)
