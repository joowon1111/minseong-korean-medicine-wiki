---
title: 옥예 ST15
description: 옥예 ST15 표준 위치·취혈·임상 지식망
status: 검토완료
...
먼저 복장뼈각(sternal angle)과 같은 높이에서 둘째 갈비뼈(the 2nd rib)를 찾으면, 그 아래가 둘째 갈비사이공간이 된다. 남성의 경우는 젖꼭지(nipple)에서 위쪽으로 갈비뼈 2개만큼 올라와도 된다. 본래 갈비뼈가 활모양으로 휘었기 때문에, 屋翳(ST15)는 神藏(KI25)보다 약간 위쪽에 위치한다.
...
- **대표 주치·용도:** 기침 · 천명·천식 증상 · 숨참 [전통 주치·교육자료](https://www.americandragon.com/Points/ST-15.html)
...
**표준 정보:** [KMCRIC 옥예 ST15](https://www.kmcric.com/database/acupoint/ST/ST15)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
