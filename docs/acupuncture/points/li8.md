---
title: 하렴 LI8
description: 하렴 LI8 표준 위치·취혈·임상 지식망
status: 검토완료
...
陽谿(LI5)와 曲池(LI11)를 연결하는 선 위, 위쪽으로부터 1/3과 아래쪽으로부터 2/3가 되는 지점, 上廉(LI9)에서 아래쪽으로 1寸 지점에서 취혈한다.
...
- **대표 주치·용도:** 복통 · 복부팽만 · 옆구리 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/LI-8.html)
- **효능·활용 방향:** 치료 목표 — 복통의 완화와 복부팽만의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 하렴 LI8](https://www.kmcric.com/database/acupoint/LI/LI8)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
