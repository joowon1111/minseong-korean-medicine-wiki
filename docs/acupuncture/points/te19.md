---
title: 노식 TE19
description: 노식 TE19 표준 위치·취혈·임상 지식망
status: 검토완료
...
- **대표 주치·용도:** 두통 · 어지럼 · 이명 [전통 주치·교육자료](https://www.americandragon.com/Points/SJ-19.html)
...
**표준 정보:** [KMCRIC 노식 TE19](https://www.kmcric.com/database/acupoint/TE/TE19)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
- 斜刺 0.1～0.3寸 (0.1寸 刺入한 후 後方을 향해 0.5寸 斜刺하기도 한다)
