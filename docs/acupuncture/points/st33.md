---
title: 음시 ST33
description: 음시 ST33 표준 위치·취혈·임상 지식망
status: 검토완료
...
伏兎(ST32)와 무릎뼈바닥 가쪽끝을 연결하는 선의 중점에서 취혈한다.
...
- **대표 주치·용도:** 하지 통증 · 무릎 통증·불편 [전통 주치·교육자료](https://www.americandragon.com/Points/ST-33.html)
...
**표준 정보:** [KMCRIC 음시 ST33](https://www.kmcric.com/database/acupoint/ST/ST33)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
