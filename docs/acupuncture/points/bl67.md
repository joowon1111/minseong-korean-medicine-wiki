...
| 항목 | 내용 |
|---|---|
| 대표 주치·용도 | 두통 · 눈 통증 · 태위 이상에 대한 전통 뜸 활용 |
| 효능의 전통적 설명 | 활혈 — 전통적 혈행 정체를 조절; 통경 — 경맥의 통증·불편을 조절 |
| 임상 평가·활용 | 두통 등 일반 주치와 태위 이상에서의 뜸 적용은 구분합니다. 임신 중에는 산과 평가·임신 주수·적응을 확인하며 자가 시술로 연결하지 않습니다. [평가 자료](../../acupuncture-integrated/safety.md) |
| 주치 출처 | [지음 전통 주치·교육자료](https://www.americandragon.com/Points/UB-67.html) |
