---
title: 환도 GB30
description: 환도 GB30의 위치, 소속 경맥, 특정혈 분류, 전통 주치, 임상 배혈, 해부학·안전성과 연구 방향을 정리합니다.
...
옆으로 누워 넓적다리를 올려 엉덩관절을 굽혔을 때, 쉽게 촉지된다.
...
| 소속 | 족소양담경 |
| 특정혈 | 고관절·둔부 대표혈 |
| 위치 요약 | 대전자와 천골열공을 잇는 선상에서 바깥쪽 부위 |
| 임상 연결 | 둔부·좌골신경통·고관절·하지 |

## 위치와 취혈

대전자와 천골열공을 잇는 선상에서 바깥쪽 부위를 기준으로 취혈합니다. 실제 임상에서는 체형 차이와 촉진, 뼈·근육·건·혈관·신경 등 해부학적 표지를 함께 확인합니다.
...
- **임상시험에서 사용된 분야:** 고관절 골관절염 [출처 2](https://pmc.ncbi.nlm.nih.gov/articles/PMC7564320/#jcm-09-03027-t001)
...
**표준 정보:** [KMCRIC 환도 GB30](https://www.kmcric.com/database/acupoint/GB/GB30)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
고관절 움직임·보행과 둔부에서 하지로 이어지는 통증 분포를 확인합니다. [평가 자료](../../clinical-anatomy/mps-hip.md)
...
이 혈의 **고관절·둔부 대표혈** 성격은 같은 경맥의 오수혈·원혈·락혈·극혈, 표리경 및 기경팔맥 관계와 함께 보면 더 잘 이해할 수 있습니다.

→ [특정혈 임상 지식망](../../meridian-network/special-points/index.md)

## 해부학과 안전

좌골신경과 둔부 심부 구조를 고려하며 전문적 해부 지식이 필요합니다.
