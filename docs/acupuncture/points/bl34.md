---
title: 하료 BL34
description: 하료 BL34 표준 위치·취혈·임상 지식망
status: 검토완료
...
넷째 뒤엉치뼈구멍은 손가락을 次髎(BL32)에서부터 아래쪽으로 움직이면서 찾으면 두 번째로 만져지는 오목한 곳으로, 엉치뼈틈새(sacral hiatus)와 같은 높이에 위치한다.
...
- **대표 주치·용도:** 요통 · 등 통증 · 복통 [전통 주치·교육자료](https://www.americandragon.com/Points/UB-34.html)
...
**표준 정보:** [KMCRIC 하료 BL34](https://www.kmcric.com/database/acupoint/BL/BL34)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
