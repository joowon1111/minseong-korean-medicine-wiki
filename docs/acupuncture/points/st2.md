---
title: 사백 ST2
description: 사백 ST2 표준 위치·취혈·임상 지식망
status: 검토완료
...
눈확아래구멍은 동공(pupil)에서 수직으로 아래쪽에서 촉지된다.
...
- **대표 주치·용도:** 눈 통증 · 눈 충혈 · 안면마비·입 비뚤어짐 [전통 주치·교육자료](https://www.americandragon.com/Points/ST-2.html)
- **효능·활용 방향:** 치료 목표 — 눈 통증의 완화와 눈 충혈의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 사백 ST2](https://www.kmcric.com/database/acupoint/ST/ST2)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
