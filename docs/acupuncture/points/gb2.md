---
title: 청회 GB2
description: 청회 GB2 표준 위치·취혈·임상 지식망
status: 검토완료
...
입을 벌리고, 귀구슬사이패임 앞쪽의 오목한 곳에서 취혈한다. 聽宮(SI19)에서 수직으로 아래쪽에 위치한다.
...
- **대표 주치·용도:** 이명 · 청력 저하 · 두통 [전통 주치·교육자료](https://www.americandragon.com/Points/GB-2.html)
- **효능·활용 방향:** 치료 목표 — 이명의 완화와 청력 저하의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 청회 GB2](https://www.kmcric.com/database/acupoint/GB/GB2)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
- 입을 벌리고 약간 後斜方으로 1～1.5寸 刺入하기도 한다.
