---
title: 석문 CV5
description: 석문 CV5 표준 위치·취혈·임상 지식망
status: 검토완료
...
- **대표 주치·용도:** 복통 · 복부팽만 · 소화불량 [전통 주치·교육자료](https://www.americandragon.com/Points/REN-5.html)
- **효능·활용 방향:** 조경 — 월경 관련 증상을 조절; 지통 — 통증을 완화하는 방향

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 석문 CV5](https://www.kmcric.com/database/acupoint/CV/CV5)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
