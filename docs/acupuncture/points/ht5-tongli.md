---
title: 통리 HT5
description: 통리 HT5의 위치, 소속 경맥, 특정혈 분류, 전통 주치, 임상 배혈, 해부학·안전성과 연구 방향을 정리합니다.
...
콩알뼈 몸쪽모서리 노쪽에서 몸 쪽으로 1寸, 즉 神門(HT7)에서 몸 쪽으로 1寸, 經渠(LU8)와 같은 높이에서 취혈한다. 靈道(HT4)는 자뼈머리(head of the ulna)의 뿌리, 通里(HT5)는 자뼈머리의 몸통, 陰郄(HT6)은 자뼈머리의 바닥과 같은 높이에 위치한다.
...
| 소속 | 수소음심경 |
| 특정혈 | 락혈 |
| 위치 요약 | 신문 HT7 위 1촌, 척측수근굴근건의 요측 |
| 임상 연결 | 심계·수면·언어·손목 |

## 위치와 취혈

신문 HT7 위 1촌, 척측수근굴근건의 요측를 기준으로 취혈합니다. 실제 임상에서는 체형 차이와 촉진, 뼈·근육·건·혈관·신경 등 해부학적 표지를 함께 확인합니다.
...
- **대표 주치·용도:** 두근거림 · 어지럼 [전통 주치·교육자료](https://www.americandragon.com/Points/HT-5.html)
- **효능·활용 방향:** 안신 — 긴장·수면 불편을 조절; 통경 — 경맥의 통증·불편을 조절
- **천성십이혈의 관련 부위:** 가슴를 중심으로 활용한 고전 경혈군의 해석입니다. [출처 1](https://koreascience.kr/article/JAKO202432472148656.pdf)
...
**표준 정보:** [KMCRIC 통리 HT5](https://www.kmcric.com/database/acupoint/HT/HT5)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
이 혈의 **락혈** 성격은 같은 경맥의 오수혈·원혈·락혈·극혈, 표리경 및 기경팔맥 관계와 함께 보면 더 잘 이해할 수 있습니다.

→ [특정혈 임상 지식망](../../meridian-network/special-points/index.md)

## 해부학과 안전

척골동맥·신경과 주변 건을 고려합니다.
