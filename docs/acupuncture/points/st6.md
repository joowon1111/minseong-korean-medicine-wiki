---
title: 협거 ST6
description: 협거 ST6 표준 위치·취혈·임상 지식망
status: 검토완료
...
턱뼈각의 이등분선 위, 입과 치아를 굳게 다물면 깨물근(masseter muscle)이 융기되고, 굳게 다물었던 치아를 놓으면 오목하게 느껴지는 곳에서 취혈한다.
...
- **대표 주치·용도:** 턱 통증·개구 불편 · 치통 · 안면마비·입 비뚤어짐 [전통 주치·교육자료](https://www.americandragon.com/Points/ST-6.html)
- **효능·활용 방향:** 치료 목표 — 턱 통증·개구 불편의 완화와 치통의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 협거 ST6](https://www.kmcric.com/database/acupoint/ST/ST6)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
- 斜刺 0.5～1寸 (깨물근경련 치료시 위쪽을 향해 刺入, 上‧下齒痛에는 上齒 및 下齒를 향해 刺入)
