---
title: 천돌 CV22
description: 천돌 CV22 표준 위치·취혈·임상 지식망
status: 검토완료
...
양쪽 빗장뼈(clavicle)의 안쪽끝 사이의 중점 오목한 곳에서 취혈한다.
...
- **대표 주치·용도:** 기침 · 쉰 목소리 · 인후 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/REN-22.html)
...
**표준 정보:** [KMCRIC 천돌 CV22](https://www.kmcric.com/database/acupoint/CV/CV22)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
- 橫刺 : 먼저 直刺로 0.2～0.3寸 刺入한 후 다시 아래로 향해 橫刺로 바꾸어 胸骨柄 後 氣管 前緣을 沿해서 0.7～1寸 刺入

- 直刺 0.3～0.5寸 (深刺하여 氣管을 刺傷하지 말아야 한다)
