---
title: 찬죽 BL2
description: 찬죽 BL2 표준 위치·취혈·임상 지식망
status: 검토완료
...
이마뼈패임(frontal notch), 睛明(BL1)에서 수직으로 위쪽, 눈썹 안쪽끝에서 취혈한다.
...
- **대표 주치·용도:** 눈 통증 · 두통 · 눈물흘림 [전통 주치·교육자료](https://www.americandragon.com/Points/UB-2.html)
- **효능·활용 방향:** 명목 — 눈 관련 증상을 다루는 방향; 통비규 — 코의 막힘을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 찬죽 BL2](https://www.kmcric.com/database/acupoint/BL/BL2)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
- 眼疾患 치료시 鍼尖을 下向하여 睛明(BL1)이나 外方의 絲竹空(TE23)으로 斜透刺 0.5～1寸
