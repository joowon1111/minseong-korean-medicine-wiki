---
title: 수천 KI5
description: 수천 KI5 표준 위치·취혈·임상 지식망
status: 검토완료
...
| 항목 | 내용 |
|---|---|
| 대표 주치·용도 | 월경불순 · 월경통 · 복통 |
| 효능의 전통적 설명 | 조경 — 월경 관련 증상을 조절; 활혈 — 전통적 혈행 정체를 조절 |
| 임상 평가·활용 | 월경 주기·통증 시점·출혈 양상과 임신 가능성을 확인해 배혈을 검토합니다. [평가 자료](../../acupuncture-integrated/by-symptom.md) |
| 주치 출처 | [수천 전통 주치·교육자료](https://www.americandragon.com/Points/KI-5.html) |
