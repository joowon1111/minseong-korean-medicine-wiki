---
title: 하거허 ST39
description: 하거허 ST39 표준 위치·취혈·임상 지식망
status: 검토완료
...
犢鼻(ST35) 아래쪽 9寸 부위로, 앞정강근(tibialis anterior muscle) 위에 취혈하며, 陽交(GB35)․外丘(GB36)와 같은 높이에 해당됨.
...
- **대표 주치·용도:** 복통 · 설사 · 하지 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/ST-39.html)
...
**표준 정보:** [KMCRIC 하거허 ST39](https://www.kmcric.com/database/acupoint/ST/ST39)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
