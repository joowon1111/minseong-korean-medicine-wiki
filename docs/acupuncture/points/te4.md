---
title: 양지 TE4
description: 양지 TE4 표준 위치·취혈·임상 지식망
status: 검토완료
...
손목 뒤쪽면, 손등 쪽 손목주름(dorsal wrist crease) 위, 손가락폄근힘줄(extensor digitorum tendon) 자쪽 오목한 곳.
※주 : 陽谿(LI5), 陽谷(SI5)과 같은 높이에 위치한다.

### 실제 취혈 포인트

손바닥을 아래로 하고, 저항을 주면서 손목을 손등 쪽으로 굽히면 손가락폄근힘줄을 더욱 쉽게 촉지할 수 있다. 손가락을 넷째와 다섯째 손허리뼈(the 4th and 5th metacarpal bone) 사이를 따라서 몸 쪽으로 움직이다가 손등 쪽 손목주름과 만나는 오목한 곳에서 취혈한다.
...
- **대표 주치·용도:** 손목 통증·기능 저하 · 팔 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/SJ-4.html)
- **효능·활용 방향:** 치료 목표 — 손목 통증·기능 저하의 완화와 팔 통증의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 양지 TE4](https://www.kmcric.com/database/acupoint/TE/TE4)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
