---
title: 협백 LU4
description: 협백 LU4 표준 위치·취혈·임상 지식망
status: 검토완료
...
위팔 앞가쪽면, 위팔두갈래근(biceps brachii muscle)의 가쪽모서리 바로가쪽, 앞겨드랑주름(anterior axillary
fold)에서 아래쪽으로 4寸.

### 실제 취혈 포인트

앞겨드랑주름과 尺澤(LU5)을 연결하는 선에서 위쪽으로부터 1/3과 아래쪽으로부터 2/3가 되는 지점에서 먼쪽으로 1寸에서 취혈한다.
...
- **대표 주치·용도:** 기침 · 흉부 통증·답답함 · 팔 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/LU-4.html)
...
**표준 정보:** [KMCRIC 협백 LU4](https://www.kmcric.com/database/acupoint/LU/LU4)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
