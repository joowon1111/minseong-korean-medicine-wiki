---
title: 천부 LU3
description: 천부 LU3 표준 위치·취혈·임상 지식망
status: 검토완료
...
앞겨드랑주름과 尺澤(LU5)을 연결하는 선에서 위쪽으로부터 1/3, 아래쪽으로부터 2/3가 되는 지점에서 취혈한다.
...
- **대표 주치·용도:** 기침 · 코피 · 팔 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/LU-3.html)
...
**표준 정보:** [KMCRIC 천부 LU3](https://www.kmcric.com/database/acupoint/LU/LU3)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
