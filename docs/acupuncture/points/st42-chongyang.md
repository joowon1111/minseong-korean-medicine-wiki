---
title: 충양 ST42
description: 충양 ST42의 위치, 소속 경맥, 특정혈 분류, 전통 주치, 임상 배혈, 해부학·안전성과 연구 방향을 정리합니다.
...
| 소속 | 족양명위경 |
| 특정혈 | 원혈 |
| 위치 요약 | 발등, 제2·3중족골 기저부 부근의 족배동맥 박동 부위 |
| 임상 연결 | 위경 원혈·발등·소화기 변증 연결 |

## 위치와 취혈

발등, 제2·3중족골 기저부 부근의 족배동맥 박동 부위를 기준으로 취혈합니다. 실제 임상에서는 체형 차이와 촉진, 뼈·근육·건·혈관·신경 등 해부학적 표지를 함께 확인합니다.
...
- **대표 주치·용도:** 안면마비·입 비뚤어짐 · 식욕 저하 · 위완부 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/ST-42.html)
- **효능·활용 방향:** 치료 목표 — 안면마비·입 비뚤어짐의 완화와 식욕 저하의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 충양 ST42](https://www.kmcric.com/database/acupoint/ST/ST42)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
눈 감기·입 움직임 등 안면 기능과 증상 발생 시점을 기록합니다. [평가 자료](../../acupuncture-integrated/by-symptom.md)
...
이 혈의 **원혈** 성격은 같은 경맥의 오수혈·원혈·락혈·극혈, 표리경 및 기경팔맥 관계와 함께 보면 더 잘 이해할 수 있습니다.

→ [특정혈 임상 지식망](../../meridian-network/special-points/index.md)

## 해부학과 안전

족배동맥과 인접하므로 혈관을 피해야 합니다.
