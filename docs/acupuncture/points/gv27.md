---
title: 태단 GV27
description: 태단 GV27 표준 위치·취혈·임상 지식망
status: 검토완료
...
인중 고랑 아랫부분과 붉은 입술이 이루는 경계선의 중점에서 취혈한다.
...
- **대표 주치·용도:** 코피 · 코막힘 · 턱 통증·개구 불편 [전통 주치·교육자료](https://www.americandragon.com/Points/DU-27.html)
- **효능·활용 방향:** 치료 목표 — 코피의 완화와 코막힘의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 태단 GV27](https://www.kmcric.com/database/acupoint/GV/GV27)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
