---
title: 축빈 KI9
description: 축빈 KI9 표준 위치·취혈·임상 지식망
status: 검토완료
...
무릎을 굽히고, 발바닥쪽으로 발을 굽힌채 종아리를 뻗으면, 정강뼈 안쪽모서리(medial border of the tibia)를 따라 가자미근이 현저하게 드러나는 곳이며, 太谿(KI3)와 음릉천을 연결하는 선을 13촌으로 하여 태계 위 5촌 부위, 족궐음간경 蠡溝(LR5)와 같은 높이에서 취혈한다.
...
- **대표 주치·용도:** 구토·헛구역 · 무릎 통증·불편 · 하지 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/KI-9.html)
...
**표준 정보:** [KMCRIC 축빈 KI9](https://www.kmcric.com/database/acupoint/KI/KI9)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
