---
title: 강간 GV18
description: 강간 GV18 표준 위치·취혈·임상 지식망
status: 검토완료
...
- **대표 주치·용도:** 두통 · 어지럼 · 목 통증·뻣뻣함 [전통 주치·교육자료](https://www.americandragon.com/Points/DU-18.html)
- **효능·활용 방향:** 안신 — 긴장·수면 불편을 조절; 지통 — 통증을 완화하는 방향

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 강간 GV18](https://www.kmcric.com/database/acupoint/GV/GV18)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
- 斜刺 0.5～1寸 (鍼尖을 沿皮하여 刺入, 絡却(BL8)으로 透刺하여도 좋다)
