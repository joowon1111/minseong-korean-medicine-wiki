---
title: 후계 SI3
description: 후계 SI3의 임상 활용, 배혈, 안전성과 관련 연구를 정리합니다.
tags: [경혈, 임상한의학]
---
# 후계 SI3
...
손을 약간 굽혔을 때, 손바닥의 먼 쪽 가로피부주름(distal transverse skin crease)의 자쪽 끝, 赤白肉際에서 취혈한다.
...
- **대표 주치·용도:** 목 통증·뻣뻣함 · 등 통증 · 손·손가락 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/SI-3.html)
- **효능·활용 방향:** 서근 — 근육·힘줄의 긴장을 조절; 통경 — 경맥의 통증·불편을 조절
- **천금십일혈의 관련 부위:** 머리와 뒷목의 증상을 다루는 혈로 해석했습니다. [출처 1](https://koreascience.kr/article/JAKO202432472148656.pdf)
- **팔맥교회혈의 배혈:** BL62와 함께 몸의 뒷면 부위를 다루는 전통적인 배혈로 설명됩니다. [출처 2](https://koreascience.kr/article/JAKO202432472148656.pdf)
...
**표준 정보:** [KMCRIC 후계 SI3](https://www.kmcric.com/database/acupoint/SI/SI3)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
**사암침법에서의 역할:** [소장정격 보혈](../../acupuncture-specific/saam-12-meridians.md#si)
...
- 斜刺 0.5～2寸 (주먹을 쥐고 中手骨을 沿해 外側에서 前內方으로)

- 手指痙攣 치료시 合谷을 향해 1.5～2寸 透刺

자침 깊이와 방향은 체형과 주변 혈관·신경·장기 위치를 고려해 조절하며 의료전문가의 판단이 필요합니다.

## 특정혈 속성

**특정혈 속성:** 오수혈 수혈(兪) · 목혈 · 팔맥교회혈(독맥) · BL62 신맥과 짝
...
## 임상에서 보는 포인트
**경항부·등** 관련 증상에서 다른 경혈과 함께 배혈하는 경우가 많습니다.
