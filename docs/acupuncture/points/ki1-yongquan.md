---
title: 용천 KI1
description: 용천 KI1의 위치, 소속 경맥, 특정혈 분류, 전통 주치, 임상 배혈, 해부학·안전성과 연구 방향을 정리합니다.
...
| 소속 | 족소음신경 |
| 특정혈 | 정목혈 |
| 위치 요약 | 발바닥 앞 1/3과 뒤 2/3 경계 부근의 오목한 곳 |
| 임상 연결 | 실신·열성·두면부·신경계 관련 전통 활용 |

## 위치와 취혈

발바닥 앞 1/3과 뒤 2/3 경계 부근의 오목한 곳를 기준으로 취혈합니다. 실제 임상에서는 체형 차이와 촉진, 뼈·근육·건·혈관·신경 등 해부학적 표지를 함께 확인합니다.
...
이 혈의 **정목혈** 성격은 같은 경맥의 오수혈·원혈·락혈·극혈, 표리경 및 기경팔맥 관계와 함께 보면 더 잘 이해할 수 있습니다.

→ [특정혈 임상 지식망](../../meridian-network/special-points/index.md)

## 해부학과 안전

족저의 통증 민감도와 피부 상태를 고려합니다.
