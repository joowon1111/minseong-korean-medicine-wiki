---
title: 곡차 BL4
description: 곡차 BL4 표준 위치·취혈·임상 지식망
status: 검토완료
...
神庭(GV24)과 頭維(ST8)를 연결하는 활모양의 가상선에서 안쪽으로부터 1/3, 가 쪽으로부터 2/3가 되는 지점에서 취혈한다.
...
- **대표 주치·용도:** 두통 · 코막힘 · 시야 흐림 [전통 주치·교육자료](https://www.acupuncture.com/education/points/urinarybladder/ub4.htm)
- **효능·활용 방향:** 두부·비부 증상 조절 — 두통·코막힘을 다루는 방향

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 곡차 BL4](https://www.kmcric.com/database/acupoint/BL/BL4)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
