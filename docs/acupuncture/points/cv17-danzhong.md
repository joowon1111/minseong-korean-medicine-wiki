---
title: 전중 CV17
description: 전중 CV17의 위치, 소속 경맥, 특정혈 분류, 전통 주치, 임상 배혈, 해부학·안전성과 연구 방향을 정리합니다.
tags: [경혈, 임맥, 특정혈, 침구]
---
# 전중 CV17
...
| 소속 | 임맥 |
| 특정혈 | 심포의 모혈·팔회혈 중 기회 |
| 위치 요약 | 앞가슴 정중선, 제4늑간 높이 |
| 임상 연결 | 흉민·호흡·기·심계 |

## 위치와 취혈

앞가슴 정중선, 제4늑간 높이를 기준으로 취혈합니다. 실제 임상에서는 체형 차이와 촉진, 뼈·근육·건·혈관·신경 등 해부학적 표지를 함께 확인합니다.
...
- **대표 주치·용도:** 흉부 통증·답답함 · 기침 · 숨참 [전통 주치·교육자료](https://www.americandragon.com/Points/REN-17.html)
- **효능·활용 방향:** 선폐·지해 — 기침·호흡 불편을 조절; 화위 — 위장 불편과 상역을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 전중 CV17](https://www.kmcric.com/database/acupoint/CV/CV17)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
이 혈의 **심포의 모혈·팔회혈 중 기회** 성격은 같은 경맥의 오수혈·원혈·락혈·극혈, 표리경 및 기경팔맥 관계와 함께 보면 더 잘 이해할 수 있습니다.

→ [특정혈 임상 지식망](../../meridian-network/special-points/index.md)

## 해부학과 안전

흉골 위 혈위로 수직 깊은 자침을 피하고 표층 해부학을 확인합니다.
