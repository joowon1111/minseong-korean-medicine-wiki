---
title: 척택 LU5
description: 척택 LU5의 위치, 소속 경맥, 특정혈 분류, 전통 주치, 임상 배혈, 해부학·안전성과 연구 방향을 정리합니다.
...
팔꿈치를 굽힌 상태에서 팔오금주름 위의 曲池(LI11)와 曲澤(PC3) 사이에 위치한다. 위팔두갈래근힘줄에 의해 尺澤(LU5)과 曲澤(PC3)이 나뉜다.
...
| 소속 | 수태음폐경 |
| 특정혈 | 합수혈 |
| 위치 요약 | 팔꿈치를 약간 굽혔을 때 주와 횡문 위, 상완이두근건의 가쪽 |
| 임상 연결 | 기침·호흡기·팔꿈치·상지 |

## 위치와 취혈

팔꿈치를 약간 굽혔을 때 주와 횡문 위, 상완이두근건의 가쪽를 기준으로 취혈합니다. 실제 임상에서는 체형 차이와 촉진, 뼈·근육·건·혈관·신경 등 해부학적 표지를 함께 확인합니다.
...
- **대표 주치·용도:** 기침 · 천명·천식 증상 · 팔꿈치 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/LU-5.html)
- **효능·활용 방향:** 화담 — 담 관련 증상을 조절; 서근 — 근육·힘줄의 긴장을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 척택 LU5](https://www.kmcric.com/database/acupoint/LU/LU5)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
**사암침법에서의 역할:** [폐승격 사혈](../../acupuncture-specific/saam-12-meridians.md#lu)

<!-- ACUPOINT_CLINICAL_END -->

## 자주 연결하는 배혈

**열결 LU7·합곡 LI4·중부 LU1**
