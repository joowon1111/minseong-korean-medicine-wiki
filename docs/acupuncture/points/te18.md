---
title: 계맥 TE18
description: 계맥 TE18 표준 위치·취혈·임상 지식망
status: 검토완료
...
- **대표 주치·용도:** 두통 · 이명 · 청력 저하 [전통 주치·교육자료](https://www.americandragon.com/Points/SJ-18.html)
- **효능·활용 방향:** 이규 — 귀 관련 증상을 다루는 방향

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 계맥 TE18](https://www.kmcric.com/database/acupoint/TE/TE18)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
