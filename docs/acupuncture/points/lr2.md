---
title: 행간 LR2
description: 행간 LR2 표준 위치·취혈·임상 지식망
status: 검토완료
...
| 항목 | 내용 |
|---|---|
| 대표 주치·용도 | 두통 · 눈 충혈 · 월경불순 |
| 효능의 전통적 설명 | 청열 — 열 양상의 증상을 조절 |
| 임상 평가·활용 | 두통·어지럼의 빈도와 지속시간, 동반 목 긴장·유발 상황을 기록합니다. [평가 자료](../../conditions/headache.md) |
| 주치 출처 | [행간 전통 주치·교육자료](https://www.americandragon.com/Points/LIV-2.html) |
| 사암침법에서의 역할 | [간승격 사혈](../../acupuncture-specific/saam-12-meridians.md#lr) |
