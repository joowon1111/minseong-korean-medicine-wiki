---
title: 화료 LI19
description: 화료 LI19 표준 위치·취혈·임상 지식망
status: 검토완료
...
콧구멍가쪽모서리의 수직선과 인중 도랑의 중점에 해당하는 점의 수평선의 교점에서 취혈한다.
...
- **대표 주치·용도:** 비염 증상 · 코피 · 코막힘 [전통 주치·교육자료](https://www.americandragon.com/Points/LI-19.html)
- **효능·활용 방향:** 치료 목표 — 비염 증상의 완화와 코피의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 화료 LI19](https://www.kmcric.com/database/acupoint/LI/LI19)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
