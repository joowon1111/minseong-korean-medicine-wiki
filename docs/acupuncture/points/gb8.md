---
title: 솔곡 GB8
description: 솔곡 GB8 표준 위치·취혈·임상 지식망
status: 검토완료
...
角孫(TE20) 위쪽, 髮際(hairline)에서 머리 안쪽으로 1.5寸 지점으로, 음식을 씹을 때 쉽게 촉지된다.
...
- **대표 주치·용도:** 두통 · 어지럼 · 눈 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/GB-8.html)
...
**표준 정보:** [KMCRIC 솔곡 GB8](https://www.kmcric.com/database/acupoint/GB/GB8)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
