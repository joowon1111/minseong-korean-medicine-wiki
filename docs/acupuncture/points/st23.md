---
title: 태을 ST23
description: 태을 ST23 표준 위치·취혈·임상 지식망
status: 검토완료
...
- **대표 주치·용도:** 소화불량 · 위완부 통증 · 복통 [전통 주치·교육자료](https://www.americandragon.com/Points/ST-23.html)
...
**표준 정보:** [KMCRIC 태을 ST23](https://www.kmcric.com/database/acupoint/ST/ST23)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
