---
title: 본신 GB13
description: 본신 GB13 표준 위치·취혈·임상 지식망
status: 검토완료
...
神庭(GV24)에서 頭維(ST8)를 연결하는 곡선에서 안쪽으로부터 2/3와 가쪽으로부터 1/3이 되는 지점에서 취혈한다.
...
- **대표 주치·용도:** 두통 · 어지럼 · 시야 흐림 [전통 주치·교육자료](https://www.americandragon.com/Points/GB-13.html)
...
**표준 정보:** [KMCRIC 본신 GB13](https://www.kmcric.com/database/acupoint/GB/GB13)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
