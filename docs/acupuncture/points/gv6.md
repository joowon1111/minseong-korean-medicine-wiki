---
title: 척중 GV6
description: 척중 GV6 표준 위치·취혈·임상 지식망
status: 검토완료
...
- **대표 주치·용도:** 요통 · 식욕 저하 · 설사 [전통 주치·교육자료](https://www.americandragon.com/Points/DU-6.html)
- **효능·활용 방향:** 건비 — 비위의 소화·운화 기능을 보완

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 척중 GV6](https://www.kmcric.com/database/acupoint/GV/GV6)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
