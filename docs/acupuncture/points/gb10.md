---
title: 부백 GB10
description: 부백 GB10 표준 위치·취혈·임상 지식망
status: 검토완료
...
귓바퀴끝(auricular apex)의 뒤쪽, 髮際(hairline)에서 위쪽으로 1寸이 되는 지점에서 취혈한다.
...
- **대표 주치·용도:** 두통 · 청력 저하 · 이명 [전통 주치·교육자료](https://www.americandragon.com/Points/GB-10.html)
- **효능·활용 방향:** 치료 목표 — 두통의 완화와 청력 저하의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 부백 GB10](https://www.kmcric.com/database/acupoint/GB/GB10)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
