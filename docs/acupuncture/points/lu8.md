---
title: 경거 LU8
description: 경거 LU8 표준 위치·취혈·임상 지식망
status: 검토완료
...
아래팔 앞가쪽면, 노뼈붓돌기(radial styloid process)와 노동맥(radial artery)사이, 손바닥쪽 손목주름(palmar wrist crease)에서 위쪽으로 1寸.
※주 : 太淵(LU9)에서 위쪽으로 1寸에 위치한다.
