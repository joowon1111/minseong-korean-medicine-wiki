---
title: 복류 KI7
description: 복류 KI7의 위치, 소속 경맥, 특정혈 분류, 전통 주치, 임상 배혈, 해부학·안전성과 연구 방향을 정리합니다.
...
| 소속 | 족소음신경 |
| 특정혈 | 경금혈 |
| 위치 요약 | 태계 KI3 위 2촌, 아킬레스건 앞쪽 |
| 임상 연결 | 수분대사·땀·부종·신허 |

## 위치와 취혈

태계 KI3 위 2촌, 아킬레스건 앞쪽를 기준으로 취혈합니다. 실제 임상에서는 체형 차이와 촉진, 뼈·근육·건·혈관·신경 등 해부학적 표지를 함께 확인합니다.
...
- **대표 주치·용도:** 부종 · 과도한 발한 · 배뇨 불편 [전통 주치·교육자료](https://www.americandragon.com/Points/KI-7.html)
- **효능·활용 방향:** 보신·이수 — 신허 양상과 수액·발한을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 복류 KI7](https://www.kmcric.com/database/acupoint/KI/KI7)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
**사암침법에서의 역할:** [신정격 보혈](../../acupuncture-specific/saam-12-meridians.md#ki)
...
이 혈의 **경금혈** 성격은 같은 경맥의 오수혈·원혈·락혈·극혈, 표리경 및 기경팔맥 관계와 함께 보면 더 잘 이해할 수 있습니다.

→ [특정혈 임상 지식망](../../meridian-network/special-points/index.md)

## 해부학과 안전

후경골 신경혈관다발과의 위치 관계를 고려합니다.
