---
title: 지구 TE6
description: 지구 TE6 표준 위치·취혈·임상 지식망
status: 검토완료
...
外關(TE5)에서 몸 쪽으로 1寸, 會宗(TE7)과 같은 높이, 자뼈와 노뼈 사이에서 취혈한다.
...
- **대표 주치·용도:** 변비 · 옆구리 통증 · 팔 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/SJ-6.html)
- **효능·활용 방향:** 치료 목표 — 변비의 완화와 옆구리 통증의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 지구 TE6](https://www.kmcric.com/database/acupoint/TE/TE6)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
