---
title: 하관 ST7
description: 하관 ST7 표준 위치·취혈·임상 지식망
status: 검토완료
...
입을 다물고, 上關(GB3)에서 수직으로 아래쪽, 광대활 아래쪽의 오목한 곳에서 취혈한다.
...
- **대표 주치·용도:** 턱 통증·개구 불편 · 치통 · 이명 [전통 주치·교육자료](https://www.americandragon.com/Points/ST-7.html)
...
**표준 정보:** [KMCRIC 하관 ST7](https://www.kmcric.com/database/acupoint/ST/ST7)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
