---
title: 승부 BL36
description: 승부 BL36 표준 위치·취혈·임상 지식망
status: 검토완료
...
- **대표 주치·용도:** 요통 · 좌골신경통 양상의 하지 통증 · 치핵 관련 불편 [전통 주치·교육자료](https://www.americandragon.com/Points/UB-36.html)
...
**표준 정보:** [KMCRIC 승부 BL36](https://www.kmcric.com/database/acupoint/BL/BL36)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
