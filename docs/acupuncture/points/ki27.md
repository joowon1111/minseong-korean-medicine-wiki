---
title: 수부 KI27
description: 수부 KI27 표준 위치·취혈·임상 지식망
status: 검토완료
...
璇璣(CV21)와 氣戶(ST13)의 중간 지점에서 취혈한다.
...
- **대표 주치·용도:** 기침 · 천명·천식 증상 · 흉부 통증·답답함 [전통 주치·교육자료](https://www.acupuncture.com/education/points/kidney/kid27.htm)
- **효능·활용 방향:** 관흉·강역 — 기침과 흉부 불편을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 수부 KI27](https://www.kmcric.com/database/acupoint/KI/KI27)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
