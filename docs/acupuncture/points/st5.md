---
title: 대영 ST5
description: 대영 ST5 표준 위치·취혈·임상 지식망
status: 검토완료
...
입을 다물고, 입안에 공기를 채울 때, 아래턱뼈뿔 아래앞쪽에 나타나는 도랑처럼 패인 오목한 곳에서 취혈한다.
...
- **대표 주치·용도:** 치통 · 볼 부종 · 턱 통증·개구 불편 [전통 주치·교육자료](https://www.acupuncture.com/education/points/stomach/st5.htm)
- **효능·활용 방향:** 거풍·소종 — 안면의 붓기·턱 불편을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 대영 ST5](https://www.kmcric.com/database/acupoint/ST/ST5)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
