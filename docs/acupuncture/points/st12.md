---
title: 결분 ST12
description: 결분 ST12 표준 위치·취혈·임상 지식망
status: 검토완료
...
- **대표 주치·용도:** 목 통증·뻣뻣함 · 천명·천식 증상 · 딸꾹질 [전통 주치·교육자료](https://www.americandragon.com/Points/ST-12.html)
...
**표준 정보:** [KMCRIC 결분 ST12](https://www.kmcric.com/database/acupoint/ST/ST12)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
- 宜橫刺(直下에는 肺尖部가 있고, 바깥목동맥, 빗장밑동․정맥이 있어 刺鍼으로 손상받는 것을 방지하기 위하여 橫刺한다.)

- 不宜深刺(『鍼灸甲乙經』:“刺太深令人逆息”) 또는 不可向下直刺
