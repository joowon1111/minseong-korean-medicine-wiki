---
title: 비노 LI14
description: 비노 LI14 표준 위치·취혈·임상 지식망
status: 검토완료
...
- **대표 주치·용도:** 어깨 통증 · 팔 통증 · 눈 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/LI-14.html)
...
**표준 정보:** [KMCRIC 비노 LI14](https://www.kmcric.com/database/acupoint/LI/LI14)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
- 眼疾患 치료시 上向으로 三角筋中에 1～1.5寸 斜刺

- 橫刺時 上腕骨前緣에서 後緣을 향해 1～1.5寸 透刺.

- 肩臂痛 치료시 鍼尖을 上方으로 肩髃(LI15)를 향해 1～1.5寸 橫刺로 透刺.
