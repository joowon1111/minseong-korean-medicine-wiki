...
| 항목 | 내용 |
|---|---|
| 대표 주치·용도 | 어깨 통증 · 목 통증·뻣뻣함 · 과도한 발한 |
| 효능의 전통적 설명 | 통경 — 경맥의 통증·불편을 조절; 지통 — 통증을 완화하는 방향 |
| 임상 평가·활용 | 팔 올리기·등 뒤로 손 보내기와 야간 통증을 비교해 배혈 목적을 정합니다. [평가 자료](../../conditions/shoulder-pain.md) |
| 주치 출처 | [견정 전통 주치·교육자료](https://www.americandragon.com/Points/SI-9.html) |
