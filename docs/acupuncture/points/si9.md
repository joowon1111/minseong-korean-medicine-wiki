---
title: 견정 SI9
description: 견정 SI9 표준 위치·취혈·임상 지식망
status: 검토완료
...
팔을 몸통에 붙이고, 뒤겨드랑주름 끝에서 위쪽으로 1寸, 어깨세모근(deltoid muscle)의 뒤에서 취혈한다.
...
- **대표 주치·용도:** 어깨 통증 · 목 통증·뻣뻣함 · 과도한 발한 [전통 주치·교육자료](https://www.americandragon.com/Points/SI-9.html)
...
**표준 정보:** [KMCRIC 견정 SI9](https://www.kmcric.com/database/acupoint/SI/SI9)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
