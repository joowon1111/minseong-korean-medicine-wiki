---
title: 공최 LU6
description: 공최 LU6 표준 위치·취혈·임상 지식망
status: 검토완료
...
팔을 펴고 손바닥을 위로 향하게 한 자세에서, 尺澤(LU5)과 太淵(LU9)을 연결하는 선의 중점에서 위쪽으로 1寸에서 취혈한다.
...
- **대표 주치·용도:** 기침 · 인후 통증 · 팔꿈치 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/LU-6.html)
...
**표준 정보:** [KMCRIC 공최 LU6](https://www.kmcric.com/database/acupoint/LU/LU6)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
