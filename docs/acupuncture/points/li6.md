---
title: 편력 LI6
description: 편력 LI6 표준 위치·취혈·임상 지식망
status: 검토완료
...
陽谿(LI5)와 曲池(LI11)를 연결하는 선에서 위쪽으로부터 3/4, 아래쪽으로부터 1/4이 되는 지점에서 취혈한다.
...
- **대표 주치·용도:** 부종 · 목 건조감 · 팔 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/LI-6.html)
- **효능·활용 방향:** 치료 목표 — 부종의 완화와 목 건조감의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 편력 LI6](https://www.kmcric.com/database/acupoint/LI/LI6)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
