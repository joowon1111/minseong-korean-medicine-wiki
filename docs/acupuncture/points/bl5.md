---
title: 오처 BL5
description: 오처 BL5 표준 위치·취혈·임상 지식망
status: 검토완료
...
- **대표 주치·용도:** 두통 · 어지럼 · 시야 흐림 [전통 주치·교육자료](https://www.americandragon.com/Points/UB-5.html)
- **효능·활용 방향:** 청열 — 열 양상의 증상을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 오처 BL5](https://www.kmcric.com/database/acupoint/BL/BL5)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
- 橫刺時는 鍼尖을 向上 혹은 向下하여 皮下를 沿하여 0.3～0.5寸 刺入
