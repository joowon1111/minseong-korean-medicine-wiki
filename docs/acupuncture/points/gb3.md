---
title: 상관 GB3
description: 상관 GB3 표준 위치·취혈·임상 지식망
status: 검토완료
...
광대활 위쪽, 下關(ST7) 위쪽의 오목한 곳에서 취혈한다.
...
- **대표 주치·용도:** 이명 · 청력 저하 · 안면마비·입 비뚤어짐 [전통 주치·교육자료](https://www.americandragon.com/Points/GB-3.html)
...
**표준 정보:** [KMCRIC 상관 GB3](https://www.kmcric.com/database/acupoint/GB/GB3)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
