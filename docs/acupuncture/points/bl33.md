---
title: 중료 BL33
description: 중료 BL33 표준 위치·취혈·임상 지식망
status: 검토완료
...
셋째 뒤엉치뼈구멍은 손가락을 次髎(BL32)에서부터 아래쪽으로 움직이면서 찾으면 처음으로 촉지되는 오목한 곳이다.
...
- **대표 주치·용도:** 배뇨 불편 · 변비 · 설사 [전통 주치·교육자료](https://www.americandragon.com/Points/UB-33.html)
- **효능·활용 방향:** 치료 목표 — 배뇨 불편의 완화와 변비의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 중료 BL33](https://www.kmcric.com/database/acupoint/BL/BL33)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
