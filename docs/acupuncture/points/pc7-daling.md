---
title: 대릉 PC7
description: 대릉 PC7의 취혈, 임상 배혈, 안전성과 관련 연구를 정리합니다.
tags: [경혈, 침구, 임상한의학]
---
# 대릉 PC7
...
- **문헌에서 확인한 관련 부위:** 흉부 · 안면 관련 증상 — 『침구경험방』 분석 [출처 1](https://pmc.ncbi.nlm.nih.gov/articles/PMC4619912/#sec3)

**현대 임상 활용**

- **불면장애 지침의 변증별 추가 혈위:** 심담기허 변증에 추가하는 혈로 제시됩니다. 모든 불면 환자의 공통 배혈은 아닙니다. [출처 2](https://nikom.or.kr/nckm/module/practiceGuide/view.do?guide_idx=164&menu_idx=14)

진료지침의 배혈에서 맡는 역할입니다. 단일혈의 독립적인 효과를 뜻하지 않습니다.

**현대 연구에서 다루어진 분야**

- **임상시험에서 사용된 분야:** 손목터널증후군 [출처 3](https://pmc.ncbi.nlm.nih.gov/articles/PMC7564320/#jcm-09-03027-t001)
...
**표준 정보:** [KMCRIC 대릉 PC7](https://www.kmcric.com/database/acupoint/PC/PC7)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
손 저림의 분포·야간 증상·무지구 근력과 정중신경 포착 여부를 평가합니다. [평가 자료](../../conditions/limb-numbness.md)

임상 평가는 아카이브의 평가·기록 안내입니다.

**사암침법에서의 역할:** [심포승격 사혈](../../acupuncture-specific/saam-12-meridians.md#pc)
...
## 임상에서 보는 포인트
**손목·심계·안신 관련 배혈**에 자주 연결되는 경혈입니다.
