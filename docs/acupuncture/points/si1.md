---
title: 소택 SI1
description: 소택 SI1 표준 위치·취혈·임상 지식망
status: 검토완료
...
새끼손톱의 자쪽모서리를 지나는 수직선과 손톱뿌리를 지나는 수평선이 만나는 지점에서 취혈한다.
...
- **대표 주치·용도:** 유즙 분비 부족 · 인후 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/SI-1.html)
...
**표준 정보:** [KMCRIC 소택 SI1](https://www.kmcric.com/database/acupoint/SI/SI1)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
