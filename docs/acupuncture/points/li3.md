---
title: 삼간 LI3
description: 삼간 LI3 표준 위치·취혈·임상 지식망
status: 검토완료
...
주먹을 가볍게 쥐고, 둘째 손허리손가락관절 노쪽의 몸 쪽 오목한 곳에서 취혈한다.
...
- **대표 주치·용도:** 치통 · 인후 통증 · 손·손가락 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/LI-3.html)
- **효능·활용 방향:** 이인 — 인후 불편을 조절; 명목 — 눈 관련 증상을 다루는 방향

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 삼간 LI3](https://www.kmcric.com/database/acupoint/LI/LI3)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
