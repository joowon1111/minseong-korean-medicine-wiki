---
title: 복결 SP14
description: 복결 SP14 표준 위치·취혈·임상 지식망
status: 검토완료
...
- **대표 주치·용도:** 복부팽만 · 설사 · 변비 [전통 주치·교육자료](https://www.americandragon.com/Points/SP-14.html)
...
**표준 정보:** [KMCRIC 복결 SP14](https://www.kmcric.com/database/acupoint/SP/SP14)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
