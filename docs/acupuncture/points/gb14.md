---
title: 양백 GB14
description: 양백 GB14 표준 위치·취혈·임상 지식망
status: 검토완료
...
- **대표 주치·용도:** 시야 흐림 · 두통 · 어지럼 [전통 주치·교육자료](https://www.americandragon.com/Points/GB-14.html)
- **효능·활용 방향:** 치료 목표 — 시야 흐림의 완화와 두통의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 양백 GB14](https://www.kmcric.com/database/acupoint/GB/GB14)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
- 橫刺하여 魚腰로 透刺 0.3～0.5寸 (위에서 아래로 皮下部를 沿하여 刺入)
