---
title: 지양 GV9
description: 지양 GV9 표준 위치·취혈·임상 지식망
status: 검토완료
...
양쪽 어깨뼈 아래각(inferior angle of the scapula) 아래모서리를 지나는 수평선과 뒤정중선(posterior median line)이 만나는 지점이 일곱째 등뼈(the 7th thoracic vertebra)가 된다. 그 가시돌기 아래쪽 오목한 곳에서 취혈한다.
...
- **대표 주치·용도:** 요통 · 기침 · 식욕 저하 [전통 주치·교육자료](https://www.americandragon.com/Points/DU-9.html)
- **효능·활용 방향:** 건비 — 비위의 소화·운화 기능을 보완; 이습 — 수습 관련 증상을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 지양 GV9](https://www.kmcric.com/database/acupoint/GV/GV9)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
