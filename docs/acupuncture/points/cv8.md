---
title: 신궐 CV8
description: 신궐 CV8 표준 위치·취혈·임상 지식망
status: 검토완료
...
- **대표 주치·용도:** 설사 · 복통 · 탈항 [전통 주치·교육자료](https://www.americandragon.com/Points/REN-8.html)
- **효능·활용 방향:** 온중·조장 — 뜸을 통한 복부·배변 증상 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 신궐 CV8](https://www.kmcric.com/database/acupoint/CV/CV8)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
복부·배변 증상을 평가하며, 신궐은 직접 자침하지 않습니다. 뜸의 적용 여부와 화상 예방을 별도로 판단합니다. [평가 자료](../../acupuncture-integrated/safety.md)
...
신궐은 자침하지 않습니다. 뜸은 피부 상태·감각과 열 자극을 확인해 화상을 예방합니다.
