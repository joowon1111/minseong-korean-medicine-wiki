---
title: 음포 LR9
description: 음포 LR9 표준 위치·취혈·임상 지식망
status: 검토완료
...
근육에 긴장을 준 상태에서 엉덩이를 살짝 굽혀 외전하면, 넙다리빗근이 현저하게 드러난다. 넙다리빗근 뒤쪽에서 취혈한다.
...
- **대표 주치·용도:** 요통 · 등 통증 · 월경불순 [전통 주치·교육자료](https://www.americandragon.com/Points/LIV-9.html)
...
**표준 정보:** [KMCRIC 음포 LR9](https://www.kmcric.com/database/acupoint/LR/LR9)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
