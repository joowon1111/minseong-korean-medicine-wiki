---
title: 상료 BL31
description: 상료 BL31 표준 위치·취혈·임상 지식망
status: 검토완료
...
첫째 뒤엉치뼈구멍은 손가락을 次髎(BL32)에서부터 위쪽으로 움직이면서 찾으면 오목하게 만져진다.
...
- **대표 주치·용도:** 요통 · 배뇨 불편 · 월경불순 [전통 주치·교육자료](https://www.americandragon.com/Points/UB-31.html)
...
**표준 정보:** [KMCRIC 상료 BL31](https://www.kmcric.com/database/acupoint/BL/BL31)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
