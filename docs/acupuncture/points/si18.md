---
title: 관료 SI18
description: 관료 SI18 표준 위치·취혈·임상 지식망
status: 검토완료
...
광대뼈 아래모서리의 수평선과 가쪽눈 구석의 수직선이 만나는 부위의 오목한 곳에서 취혈한다.
...
- **대표 주치·용도:** 안면마비·입 비뚤어짐 · 치통 [전통 주치·교육자료](https://www.americandragon.com/Points/SI-18.html)
- **효능·활용 방향:** 청열 — 열 양상의 증상을 조절; 지통 — 통증을 완화하는 방향

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 관료 SI18](https://www.kmcric.com/database/acupoint/SI/SI18)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
