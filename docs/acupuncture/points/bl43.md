---
title: 고황 BL43
description: 고황 BL43 표준 위치·취혈·임상 지식망
status: 검토완료
...
- **대표 주치·용도:** 어깨 통증 · 기침 · 천명·천식 증상 [전통 주치·교육자료](https://www.americandragon.com/Points/UB-43.html)
- **효능·활용 방향:** 치료 목표 — 어깨 통증의 완화와 기침의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 고황 BL43](https://www.kmcric.com/database/acupoint/BL/BL43)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
- 斜刺 0.3～0.8寸 (背側에서 前外傍을 향하거나 肩胛骨下를 향해 자입)
