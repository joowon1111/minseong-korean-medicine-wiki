---
title: 지정 SI7
description: 지정 SI7 표준 위치·취혈·임상 지식망
status: 검토완료
...
陽谷(SI5)과 小海(SI8)를 연결하는 선의 중점에서 먼 쪽으로 1寸 지점에서 취혈한다.
...
- **대표 주치·용도:** 목 통증·뻣뻣함 · 팔 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/SI-7.html)
...
**표준 정보:** [KMCRIC 지정 SI7](https://www.kmcric.com/database/acupoint/SI/SI7)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
