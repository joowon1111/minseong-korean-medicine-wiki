---
title: 인영 ST9
description: 인영 ST9 표준 위치·취혈·임상 지식망
status: 검토완료
...
저항을 받으며 머리를 반대편으로 돌리면 목빗근이 현저하게 드러난다.
...
- **대표 주치·용도:** 천명·천식 증상 · 숨참 · 구토·헛구역 [전통 주치·교육자료](https://www.americandragon.com/Points/ST-9.html)
- **효능·활용 방향:** 치료 목표 — 천명·천식 증상의 완화와 숨참의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 인영 ST9](https://www.kmcric.com/database/acupoint/ST/ST9)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
