---
title: 장문 LR13
description: 장문 LR13의 위치, 소속 경맥, 특정혈 분류, 전통 주치, 임상 배혈, 해부학·안전성과 연구 방향을 정리합니다.
...
옆으로 누워 팔을 머리 위쪽으로 올린 자세에서 취혈한다. 먼저 열째 갈비뼈 (the 10th rib)를 찾은 후, 갈비뼈활(costal arch) 아래모서리 바로 밑에서 열한째 갈비뼈끝을 찾아 취혈한다.
...
제11늑골 끝 아래를 기준으로 취혈합니다. 실제 임상에서는 체형 차이와 촉진, 뼈·근육·건·혈관·신경 등 해부학적 표지를 함께 확인합니다.
...
- **대표 주치·용도:** 복부팽만 · 소화불량 · 설사 [전통 주치·교육자료](https://www.americandragon.com/Points/LIV-13.html)
- **효능·활용 방향:** 치료 목표 — 복부팽만의 완화와 소화불량의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 장문 LR13](https://www.kmcric.com/database/acupoint/LR/LR13)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
이 혈의 **비의 모혈·팔회혈 중 장회** 성격은 같은 경맥의 오수혈·원혈·락혈·극혈, 표리경 및 기경팔맥 관계와 함께 보면 더 잘 이해할 수 있습니다.

→ [특정혈 임상 지식망](../../meridian-network/special-points/index.md)

## 해부학과 안전

복강 장기와 늑골 하연을 고려해 깊은 자침을 피합니다.
