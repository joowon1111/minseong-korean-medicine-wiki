---
title: 수오리 LI13
description: 수오리 LI13 표준 위치·취혈·임상 지식망
status: 검토완료
...
위팔두갈래근(biceps brachii muscle) 노쪽모서리와 위팔뼈(humerus)의 사이, 앞겨드랑주름(anterior axillary fold)끝과 曲池(LI11)를 연결하는 선에서 위쪽으로부터 2/3와 아래쪽으로부터 1/3이 되는 지점과 같은 높이에서 취혈한다.
...
- **대표 주치·용도:** 팔꿈치 통증 · 팔 통증 · 기침 [전통 주치·교육자료](https://www.americandragon.com/Points/LI-13.html)
...
**표준 정보:** [KMCRIC 수오리 LI13](https://www.kmcric.com/database/acupoint/LI/LI13)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
- 直刺 0.3～0.5寸 (혈관을 피하여 鍼尖을 臂外面에서 內側面을 향해 刺入)
