...
| 항목 | 내용 |
|---|---|
| 대표 주치·용도 | 치핵 관련 불편 · 탈항 |
| 효능의 전통적 설명 | 조장 — 배변 기능을 조절; 안신 — 긴장·수면 불편을 조절 |
| 임상 평가·활용 | 대변 횟수·형태, 복통·팽만과 식사의 관계를 같은 기준으로 비교합니다. [평가 자료](../../acupuncture-integrated/by-symptom.md) |
| 주치 출처 | [장강 전통 주치·교육자료](https://www.americandragon.com/Points/DU-1.html) |
