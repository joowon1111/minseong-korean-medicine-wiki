---
title: 장강 GV1
description: 장강 GV1 표준 위치·취혈·임상 지식망
status: 검토완료
...
무릎을 꿇고 엎드리거나 혹은 무릎을 가슴에 대고 취혈한다.
...
- **대표 주치·용도:** 치핵 관련 불편 · 탈항 [전통 주치·교육자료](https://www.americandragon.com/Points/DU-1.html)
- **효능·활용 방향:** 조장 — 배변 기능을 조절; 안신 — 긴장·수면 불편을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 장강 GV1](https://www.kmcric.com/database/acupoint/GV/GV1)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
대변 횟수·형태, 복통·팽만과 식사의 관계를 같은 기준으로 비교합니다. [평가 자료](../../acupuncture-integrated/by-symptom.md)
...
- 斜刺 1～1.5寸 (上方으로 향하여 尾骨과 直腸사이를 平行으로 刺入)
