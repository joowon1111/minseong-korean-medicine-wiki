...
| 항목 | 내용 |
|---|---|
| 대표 주치·용도 | 팔 통증 · 흉부 통증·답답함 |
| 효능의 전통적 설명 | 통경 — 경맥의 통증·불편을 조절; 청열 — 열 양상의 증상을 조절 |
| 임상 평가·활용 | 팔의 움직임과 감각 분포·근력, 목·어깨와의 연관성을 함께 평가합니다. [평가 자료](../../conditions/limb-numbness.md) |
| 주치 출처 | [극천 전통 주치·교육자료](https://www.americandragon.com/Points/HT-1.html) |
