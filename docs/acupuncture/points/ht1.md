---
title: 극천 HT1
description: 극천 HT1 표준 위치·취혈·임상 지식망
status: 검토완료
...
팔꿈치를 구부리고 팔을 들어 손바닥을 머리 뒤쪽에 두고, 겨드랑동맥이 뛰는 부위를 취혈한다.
...
- **대표 주치·용도:** 팔 통증 · 흉부 통증·답답함 [전통 주치·교육자료](https://www.americandragon.com/Points/HT-1.html)
- **효능·활용 방향:** 통경 — 경맥의 통증·불편을 조절; 청열 — 열 양상의 증상을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 극천 HT1](https://www.kmcric.com/database/acupoint/HT/HT1)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
팔의 움직임과 감각 분포·근력, 목·어깨와의 연관성을 함께 평가합니다. [평가 자료](../../conditions/limb-numbness.md)
