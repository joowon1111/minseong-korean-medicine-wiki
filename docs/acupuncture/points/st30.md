---
title: 기충 ST30
description: 기충 ST30 표준 위치·취혈·임상 지식망
status: 검토완료
...
- **대표 주치·용도:** 복통 · 월경불순 · 배뇨 불편 [전통 주치·교육자료](https://www.americandragon.com/Points/ST-30.html)
- **효능·활용 방향:** 화위 — 위장 불편과 상역을 조절; 조경 — 월경 관련 증상을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 기충 ST30](https://www.kmcric.com/database/acupoint/ST/ST30)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
- 斜刺 0.5～1寸 (鍼尖을 外陰部로 향해 刺入한다. 자침시 동맥을 피하여 출혈되지 않도록 한다.)
