---
title: 중려수 BL29
description: 중려수 BL29 표준 위치·취혈·임상 지식망
status: 검토완료
...
- **대표 주치·용도:** 복부팽만 · 좌골신경통 양상의 하지 통증 · 등 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/UB-29.html)
...
**표준 정보:** [KMCRIC 중려수 BL29](https://www.kmcric.com/database/acupoint/BL/BL29)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
