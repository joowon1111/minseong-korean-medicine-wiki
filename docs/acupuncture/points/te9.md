---
title: 사독 TE9
description: 사독 TE9 표준 위치·취혈·임상 지식망
status: 검토완료
...
陽池(TE4)와 팔꿈치머리 융기를 연결하는 선의 중점에서 몸 쪽으로 1寸 지점에서 취혈한다.
...
- **대표 주치·용도:** 청력 저하 · 두통 · 어지럼 [전통 주치·교육자료](https://www.americandragon.com/Points/SJ-9.html)
- **효능·활용 방향:** 이인 — 인후 불편을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 사독 TE9](https://www.kmcric.com/database/acupoint/TE/TE9)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
