---
title: 미충 BL3
description: 미충 BL3 표준 위치·취혈·임상 지식망
status: 검토완료
...
神庭(GV24)을 지나는 수평선과 攢竹(BL2)을 지나는 수직선이 만나는 곳에서 취혈한다. 神庭(GV24)과 曲差(BL4) 사이의 중간에 위치한다.
...
- **대표 주치·용도:** 두통 · 어지럼 · 코막힘 [전통 주치·교육자료](https://www.americandragon.com/Points/UB-3.html)
- **효능·활용 방향:** 치료 목표 — 두통의 완화와 어지럼의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 미충 BL3](https://www.kmcric.com/database/acupoint/BL/BL3)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
- 斜刺 0.3～0.5寸 (鍼尖을 上方 혹은 外方으로 향하고 피부를 沿하여 橫刺)
