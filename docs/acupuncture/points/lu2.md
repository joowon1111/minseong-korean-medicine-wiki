---
title: 운문 LU2
description: 운문 LU2 표준 위치·취혈·임상 지식망
status: 검토완료
...
앞가슴부위, 빗장아래오목(infra- clavicular fossa), 어깨뼈 부리돌기(coracoid process) 안쪽, 앞정중선(anterior median line)에서 가쪽으로 6寸 오목한 곳.
※주 : 氣戶(ST13), 兪府(KI27), 璇璣(CV21), 雲門(LU2)은 빗장뼈아래선을 따라 가로선 위에 위치한다.

### 실제 취혈 포인트

저항을 준 상태에서 팔을 약간 굽히고 벌릴 때 나타나는 어깨세모-가슴 삼각부위(deltopectoral triangle)의 중심에 취혈한다.
...
- **대표 주치·용도:** 기침 · 숨참 · 어깨 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/LU-2.html)
- **효능·활용 방향:** 선폐·지해 — 기침·호흡 불편을 조절; 청열 — 열 양상의 증상을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 운문 LU2](https://www.kmcric.com/database/acupoint/LU/LU2)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
