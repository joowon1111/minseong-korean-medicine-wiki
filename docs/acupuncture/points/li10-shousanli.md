---
title: 수삼리 LI10
description: 수삼리 LI10의 위치, 소속 경맥, 특정혈 분류, 전통 주치, 임상 배혈, 해부학·안전성과 연구 방향을 정리합니다.
...
| 소속 | 수양명대장경 |
| 특정혈 | 경맥 상의 주요 원위혈 |
| 위치 요약 | 곡지 LI11 아래 약 2촌, 전완 가쪽 |
| 임상 연결 | 팔꿈치·전완·상지 통증·기능 |

## 위치와 취혈

곡지 LI11 아래 약 2촌, 전완 가쪽를 기준으로 취혈합니다. 실제 임상에서는 체형 차이와 촉진, 뼈·근육·건·혈관·신경 등 해부학적 표지를 함께 확인합니다.
...
- **임상시험에서 사용된 분야:** 만성콩팥병 [출처 1](https://pmc.ncbi.nlm.nih.gov/articles/PMC7564320/#jcm-09-03027-t001)
- **자료의 의미:** 경혈 선택과 질환의 관련성을 분석한 자료이며, 해당 혈의 치료 효과를 평가한 결과는 아닙니다.

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>

1. **임상시험의 경혈 사용 양상 분석** — Hwang YC·Lee IS·Ryu Y·Lee YS·Chae Y. [Identification of Acupoint Indication from Reverse Inference: Data Mining of Randomized Controlled Clinical Trials](https://pmc.ncbi.nlm.nih.gov/articles/PMC7564320/#jcm-09-03027-t001). Journal of Clinical Medicine. 2020;9(9):3027. 경희대학교·한국한의학연구원·가천대학교. **표 1·고찰의 한계**. DOI: 10.3390/jcm9093027.

**표준 정보:** [KMCRIC 수삼리 LI10](https://www.kmcric.com/database/acupoint/LI/LI10)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
신기능·동반 질환과 증상 변화는 담당 진료와 함께 평가합니다. [평가 자료](../../acupuncture-integrated/evidence.md)
...
**곡지 LI11·합곡 LI4·견우 LI15**

배혈은 주증과 동반 증상에 따라 국소혈·원위혈·특정혈을 조합하고, 필요에 따라 침·전침·뜸 등 자극 방식을 달리합니다.

## 특정혈 체계에서 보기

이 혈의 **경맥 상의 주요 원위혈** 성격은 같은 경맥의 오수혈·원혈·락혈·극혈, 표리경 및 기경팔맥 관계와 함께 보면 더 잘 이해할 수 있습니다.

→ [특정혈 임상 지식망](../../meridian-network/special-points/index.md)

## 해부학과 안전

요골신경 가지와 주변 근육층을 고려합니다.
