...
- **대표 주치·용도:** 발 통증 · 두통 · 시야 흐림 [전통 주치·교육자료](https://www.americandragon.com/Points/UB-64.html)
- **효능·활용 방향:** 치료 목표 — 발 통증의 완화와 두통의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 경골 BL64](https://www.kmcric.com/database/acupoint/BL/BL64)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
체중 싣기·발목 움직임과 보행 시 통증을 비교합니다. [평가 자료](../../conditions/ankle-pain.md)
