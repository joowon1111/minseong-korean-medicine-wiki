---
title: 합양 BL55
description: 합양 BL55 표준 위치·취혈·임상 지식망
status: 검토완료
...
오금주름의 가쪽 끝과 가쪽 복사융기를 이은 선을 (또는 오금주름 중점과 委中(BL40)과 아킬레스건 중점을 연결하는 선을) 16촌으로 하여, 委中(BL40)에서 먼 쪽으로 2寸 부위에 취혈한다.
...
- **대표 주치·용도:** 요통 · 등 통증 · 하지 통증 [전통 주치·교육자료](https://www.americandragon.com/Points/UB-55.html)
...
**표준 정보:** [KMCRIC 합양 BL55](https://www.kmcric.com/database/acupoint/BL/BL55)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
