---
title: 중저 TE3
description: 중저 TE3 표준 위치·취혈·임상 지식망
status: 검토완료
...
| 항목 | 내용 |
|---|---|
| 대표 주치·용도 | 이명 · 두통 · 손·손가락 통증 |
| 효능의 전통적 설명 | 이규 — 귀 관련 증상을 다루는 방향; 청열 — 열 양상의 증상을 조절 |
| 임상 평가·활용 | 이명·청력 변화의 발생 시점, 좌우와 동반 어지럼을 구분합니다. [평가 자료](../../acupuncture-integrated/by-symptom.md) |
| 주치 출처 | [중저 전통 주치·교육자료](https://www.americandragon.com/Points/SJ-3.html) |
| 사암침법에서의 역할 | [삼초정격 보혈](../../acupuncture-specific/saam-12-meridians.md#te) |
