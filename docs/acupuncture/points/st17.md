---
title: 유중 ST17
description: 유중 ST17 표준 위치·취혈·임상 지식망
status: 검토완료
...
남성의 경우, 넷째 갈비사이공간(the 4th intercostal space)에 젖꼭지의 중심이 위치한다.
...
- **대표 주치·용도:** 유두 중심의 해부학적 위치 기준점; 자침·뜸 치료 대상 아님 [전통 주치·교육자료](https://www.americandragon.com/Points/ST-17.html)
- **용도:** 취혈 기준점 — 일반적인 치료 효능을 부여하지 않음

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 유중 ST17](https://www.kmcric.com/database/acupoint/ST/ST17)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
가슴 부위 경혈의 위치를 비교하는 기준으로 사용합니다. 유중에는 침이나 뜸을 시행하지 않습니다. [평가 자료](../../acupoint-network/standard-atlas.md)
...
유중은 위치를 비교하는 기준점으로 사용하며 자침·뜸을 시행하지 않습니다.
