...
| 항목 | 내용 |
|---|---|
| 대표 주치·용도 | 유두 중심의 해부학적 위치 기준점; 자침·뜸 치료 대상 아님 |
| 용도 | 취혈 기준점 — 일반적인 치료 효능을 부여하지 않음 |
| 임상 평가·활용 | 가슴 부위 경혈의 위치를 비교하는 기준으로 사용합니다. 유중에는 침이나 뜸을 시행하지 않습니다. [평가 자료](../../acupoint-network/standard-atlas.md) |
| 주치 출처 | [유중 전통 주치·교육자료](https://www.americandragon.com/Points/ST-17.html) |
