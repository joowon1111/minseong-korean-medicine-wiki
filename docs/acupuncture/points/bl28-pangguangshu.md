---
title: 방광수 BL28
description: 방광수 BL28의 위치, 소속 경맥, 특정혈 분류, 전통 주치, 임상 배혈, 해부학·안전성과 연구 방향을 정리합니다.
...
| 소속 | 족태양방광경 |
| 특정혈 | 방광의 배수혈 |
| 위치 요약 | 제2천추 극돌기 아래에서 가쪽 1.5촌 |
| 임상 연결 | 배뇨·천장부·요천부 |

## 위치와 취혈

제2천추 극돌기 아래에서 가쪽 1.5촌를 기준으로 취혈합니다. 실제 임상에서는 체형 차이와 촉진, 뼈·근육·건·혈관·신경 등 해부학적 표지를 함께 확인합니다.
...
- **대표 주치·용도:** 배뇨 불편 · 설사 · 복통 [전통 주치·교육자료](https://www.americandragon.com/Points/UB-28.html)
- **효능·활용 방향:** 이요 — 허리의 통증·기능을 다루는 방향; 청열 — 열 양상의 증상을 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 방광수 BL28](https://www.kmcric.com/database/acupoint/BL/BL28)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
배뇨 횟수·야간뇨·통증과 잔뇨감을 구분해 기록합니다. [평가 자료](../../acupuncture-integrated/by-symptom.md)
...
이 혈의 **방광의 배수혈** 성격은 같은 경맥의 오수혈·원혈·락혈·극혈, 표리경 및 기경팔맥 관계와 함께 보면 더 잘 이해할 수 있습니다.

→ [특정혈 임상 지식망](../../meridian-network/special-points/index.md)

## 해부학과 안전

천골과 주변 신경 구조를 기준으로 안전하게 접근합니다.
