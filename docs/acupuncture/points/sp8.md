---
title: 지기 SP8
description: 지기 SP8 표준 위치·취혈·임상 지식망
status: 검토완료
...
**표준 정보:** [KMCRIC 지기 SP8](https://www.kmcric.com/database/acupoint/SP/SP8)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
