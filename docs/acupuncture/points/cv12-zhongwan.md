---
title: 중완(中脘) CV12
description: 중완(中脘) CV12의 WHO 표준 위치, 전통적 효능, 주요 임상 활용과 관련 지식망을 정리합니다.
tags: [침구학, 경혈, 중완]
status: 검토완료
...
배꼽과 칼몸통결합(xiphisternal junction)을 연결하는 선의 중점에서 취혈한다.
...
- 斜刺 1～1.5寸 (兩側 前下方으로 주위의 穴을 향해 斜刺할 수 있다)
...
## 주요 활용
### 소화불량
상복부와 위장 기능을 다루는 대표 경혈
### 오심·복만
내관·족삼리와 함께 자주 배합

## 지식망 연결
- [관련 임상 지식망](../../network/dyspepsia-acupoints.md)
