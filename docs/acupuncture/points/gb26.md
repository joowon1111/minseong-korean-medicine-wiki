---
title: 대맥 GB26
description: 대맥 GB26 표준 위치·취혈·임상 지식망
status: 검토완료
...
먼저 열째 갈비뼈(the 10th rib)를 찾은 후, 갈비뼈활(costal arch)의 아래모서리 바로 밑에서 열한째 갈비뼈끝을 찾아 그 아래에서 취혈한다. 章門(LR13)의 아래쪽, 神闕(CV8)과 같은 높이에서 취혈한다.
...
- **대표 주치·용도:** 대하 · 월경불순 · 복통 [전통 주치·교육자료](https://www.americandragon.com/Points/GB-26.html)
- **효능·활용 방향:** 치료 목표 — 대하의 완화와 월경불순의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 대맥 GB26](https://www.kmcric.com/database/acupoint/GB/GB26)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
