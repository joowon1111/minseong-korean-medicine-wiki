---
title: 지창 ST4
description: 지창 ST4 표준 위치·취혈·임상 지식망
status: 검토완료
...
입꼬리 옆쪽, 코입술고랑(nasolabialsulcus) 위 혹은 코입술고랑의 연장선상에서 취혈한다.
...
- **대표 주치·용도:** 안면마비·입 비뚤어짐 · 치통 · 턱 통증·개구 불편 [전통 주치·교육자료](https://www.americandragon.com/Points/ST-4.html)
- **효능·활용 방향:** 치료 목표 — 안면마비·입 비뚤어짐의 완화와 치통의 조절

<details markdown="1">
<summary>출처·원문과 해석 범위</summary>


**표준 정보:** [KMCRIC 지창 ST4](https://www.kmcric.com/database/acupoint/ST/ST4)에서 위치·취혈 정보를 확인할 수 있습니다. 혈명·코드·소속 경맥을 대조했으며, 이 링크를 주치·효능의 근거로 사용하지 않습니다.
...
- 顔面神經麻痺 치료시 頰車(ST6)로 透刺 1.5～2.5寸

- 三叉神經痛 치료시 迎香(LI20)으로 透刺 1～2寸
