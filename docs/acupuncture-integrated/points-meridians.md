...
description: 경혈·경락 찾기 — 경혈·경락·해부학·침·전침·약침과 임상 안전을 연결하는 침구 문서입니다.
---
# 경혈·경락 찾기
...
## 임상에서 자주 연결하는 배혈 조합 {#임상에서-자주-연결하는-배혈-조합}
...
## 오수혈·오행 배속으로 다시 보기 {#오수혈오행-배속으로-다시-보기}
...
## 12경맥 유주·표리·접속으로 다시 보기 {#12경맥-유주표리접속으로-다시-보기}
...
## 12경근으로 근골격 통증 다시 보기 {#12경근으로-근골격-통증-다시-보기}
...
## 락맥·경별로 경락 연결을 더 깊게 보기 {#락맥경별로-경락-연결을-더-깊게-보기}
...
## 기경팔맥으로 여러 경맥을 연결해서 보기 {#기경팔맥으로-여러-경맥을-연결해서-보기}
...
## 경혈 위치와 해부학적 안전을 함께 보기 {#경혈-위치와-해부학적-안전을-함께-보기}

경혈의 표준 위치를 아는 것과 **안전하게 자침하는 것**은 별개의 문제입니다.  
...
### GV16 풍부
- 후두하 정중부.
- 심부에는 중요한 중추신경계 구조가 있으므로 **해부학적 안전성이 우선**입니다.
...
1. **정확한 골성·근육성 표지를 촉진했는가**
2. 환자의 체형과 근육량은 어떤가
3. 심부에 폐·복강장기·대혈관·주요 신경이 있는가
4. 항응고제·출혈경향이 있는가
5. 피부감염·상처가 있는가
6. 임신·쇠약·실신경향 등 특수상황이 있는가
7. 전침을 사용한다면 전기자극 관련 주의사항이 있는가
...
이런 반응이 나타나면 **자극을 계속 강하게 하는 것이 아니라 즉시 상태를 재평가**합니다.
...
## 경혈 위치를 실제로 찾는 취혈법 {#경혈-위치를-실제로-찾는-취혈법}

경혈 위치는 숫자만 외우기보다 **골도분촌 + 체표 해부학적 표지 + 촉진 + 관절 움직임**을 함께 사용하면 훨씬 빠르게 찾을 수 있습니다.

## 1. 골도분촌의 기본

`촌(寸)`은 고정된 cm가 아니라 **환자의 신체 비율을 기준으로 한 상대적 거리**입니다.
...
손가락 폭은 사람마다 차이가 있으므로 **정확한 골도분촌을 대신하는 절대척도라기보다 빠른 임상 보조법**으로 사용합니다.
...
이 표지는 체형과 자세에 따라 차이가 있으므로 **촉진과 주변 극돌기를 함께 확인**합니다.
...
`혈위 위치를 정확히 찾았다 = 그 방향으로 깊게 자침해도 된다`는 뜻이 아닙니다.
...
→ [해부학적 안전](#경혈-위치와-해부학적-안전을-함께-보기)

## 근막통증증후군(MPS)·통증유발점과 경혈을 함께 보기 {#근막통증증후군mps통증유발점과-경혈을-함께-보기}
...
태극침법은 이병행이 개발한 체질침법으로 알려져 있으며, **태극을 심(心)으로 보고 사상체질과 심경의 혈 및 십이원혈을 연결해 보사하는 체계**입니다.
...
### 태극침법과 기존 특정혈 자료 연결
태극침법에서 원혈을 이해하려면 기존 **12경 원혈 표**를 같이 봅니다.

→ [원혈·락혈·특정혈 분류](#특정혈-분류로-다시-보기)
...
이침은 **이개(귓바퀴)의 특정 반응점·이혈을 자극하여 증상과 전신 상태를 조절하는 침구치료 체계**입니다.  
...
위키에서는 **이혈 위치와 치료원리**를 먼저 정리하고, 자극기법별 세부 술기는 치료수단·안전 자료와 연결합니다.
...
이침은 **일반 경혈침의 부속 혈자리 목록**이 아니라 별도의 미세체계입니다.
...
약침은 기존 경혈망을 사용할 수 있지만 **경혈 위치 = 약침 주입부위 자동결정**은 아닙니다.
