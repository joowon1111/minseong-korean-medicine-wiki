---
title: 침구·한의치료 허브
description: 경락·경혈·특정혈·배혈과 침·전침·약침·부항·뜸을 증상·변증·임상근거까지 연결합니다.
tags: [Pillar, 침구, 경혈, 배혈, 한의치료]
status: 검토완료
last_reviewed: 2026-08-22
---
# 침구·한의치료 허브

침구치료는 단순히 대표혈 몇 개를 고르는 것이 아니라 **증상과 부위 → 경맥 → 특정혈 → 변증 → 국소·원위 배혈 → 자극 방식 → 치료 반응 재평가**의 흐름으로 이해합니다.
...
- [특정혈 통합 지식망](../meridian-network/special-points/index.md)

## 특정혈 체계

오수혈 · 원혈 · 락혈 · 극혈 · 배수혈 · 모혈 · 팔회혈 · 하합혈 · 팔맥교회혈 · 원락배혈

→ [특정혈 전체 보기](../meridian-network/special-points/index.md)
...
요통 · 목어깨 · 무릎 · 소화불량 · 불면 · 비염 · 두통 · 흉민·심계 · 여성·하복부 · 냉증·피로를 [경맥→증상 지도](../acupoint-network/by-condition.md)에서 찾을 수 있습니다.

## 해부학과 안전

경혈 위치와 고전적 주치만으로 자침을 결정하지 않습니다. 신경·혈관·흉곽·복강·척추·관절 등 주변 해부학을 확인하고 부위에 따라 깊이·방향·자극량을 조절합니다.
