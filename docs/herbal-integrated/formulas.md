...
먼저 많이 쓰이는 기본방의 전체 구조와 수치·법제 확인점을 보려면 [임상 핵심 처방 50선](general-formulary.md#core-formulas-50)에서 시작하세요. 이 목록은 사용량 순위가 아니라 **임상 활용도·방제학적 중요도·기존 지식망 연결성**을 기준으로 관리하는 핵심 처방군입니다.
...
- [소요산](../formulas/xiaoyao-san.md) — 간울 + 혈허·비허
- [가미소요산](../formulas/jiawei-xiaoyao-san.md) — 간울혈허 + 울열
...
- [정천탕](../formulas/dingchuan-tang.md) — 담열옹폐
- [소자강기탕](../formulas/suzi-jiangqi-tang.md) — 상실하허 + 기역·담연
...
- [청서익기탕](../formulas/qingshu-yiqi-tang.md) — 서열 + 기진양상
- [형개연교탕](../formulas/jingjie-lianqiao-tang.md) — 풍열·울열성 이비인후
- [연교패독산](../formulas/lianqiao-baidu-san.md) — 풍열독·창양

## 수습·부종·소변

- [오령산](../formulas/wuling-san.md) — 수습·기화불리
- [저령탕](../formulas/zhuling-tang.md) — 수열호결 + 음손
- [진무탕](../formulas/zhenwu-tang.md) — 양허 + 수기내정
- [영계출감탕](../formulas/linggui-zhugan-tang.md) — 중양부족 + 담음
- [실비음](../formulas/shipi-yin.md) — 비양허 수종
- [팔정산](../formulas/bazheng-san.md) — 습열하주·열림
...
- [대시호탕](../formulas/dachaihu-tang.md) — 소양양명합병 + 열결
- [소승기탕](../formulas/xiaochengqi-tang.md) — 비교적 경한 양명부실
- [대승기탕](../formulas/dachengqi-tang.md) — 강한 양명부실·열결
