...
먼저 주요 기본방의 전체 구조와 수치·법제 확인점을 보려면 [임상 핵심 처방 100선](general-formulary.md#core-formulas-100)에서 시작하세요. 이 목록은 사용량 순위가 아니라 **임상 활용도·방제학적 중요도·기존 지식망 연결성**을 기준으로 관리하는 핵심 처방군입니다.
