...
## 먼저 알아둘 효능과 주치의 뜻 {#efficacy-indication}

- **효능(效能)**은 본초가 전통적인 병증·병기를 어떤 방향으로 다루는지 요약한 개념입니다.
- **주치(主治)**는 그 효능을 적용해 온 구체적인 증후 범위입니다.
- 같은 효능을 가진 본초도 작용의 강약, 주요 병위, 겸효능과 배오가 달라 실제 쓰임이 달라집니다.
- 현대 연구는 특정 시료와 제형에서 측정한 증상·기능·검사 지표를 보여주는 별도의 근거층이며, 전통 효능 전체와 동일하지 않습니다.

오늘날의 해표·청열·보익 같은 분류는 하나의 고전에서 완성된 표가 그대로 이어진 것이 아니라 **고전의 기미·독성·주치 기록 → 처방과 임상 경험 → 후대 병기·치법 해석 → 근현대 본초학의 교육·표준화**를 거쳐 형성되었습니다. 따라서 공통 효능은 일관되게 정의하되, 개별 본초의 특성은 별도로 읽어야 합니다.

→ [주요 효능의 공통 정의·주치·대표 본초와 방제](efficacy-indication-standard.md)

→ [효능 용어의 형성과 전통 기록·현대 연구의 구분](efficacy-indication-standard.md#history)

<span id="_10"></span>

아래는 전통적 효능에 따른 분류입니다. 본초 이름을 누르면 약용 부위·효능·배합을 볼 수 있습니다. 대표 처방은 해당 효능을 이해하는 예시이며, 같은 줄의 본초가 모든 예시 처방에 함께 들어가는 것은 아닙니다.
...
| 본초군 | 핵심 | 대표 처방·관련 문서 |
|---|---|---|
| [산조인](../herbs/ziziphus-seed.md)·복신·[원지](../herbs/polygala.md) | 양심안신 | [귀비탕](../formulas/guibi-tang.md) · [산조인탕](../formulas/suanzaoren-tang.md) |
| [산조인](../herbs/ziziphus-seed.md)·[백자인](../herbs/thuja-seed.md)·[원지](../herbs/polygala.md)·[생지황](../herbs/rehmannia-root-fresh.md) | 자음양혈·안신 | [천왕보심단](../formulas/tianwang-buxin-dan.md) |
| [용안육](../herbs/longan.md) | 양혈안신·보익심비 | [귀비탕](../formulas/guibi-tang.md) |
| [백합](../herbs/lily.md) | 양음윤폐·청심안신 | [백합의 효능과 배합](../herbs/lily.md) |

## 소간·해울 {#_8}

| 본초군 | 핵심 | 대표 처방·관련 문서 |
|---|---|---|
| [시호](../herbs/bupleurum.md)·[향부자](../herbs/cyperus.md) | 소간해울·이기 | [소요산](../formulas/xiaoyao-san.md) · [시호소간산](../formulas/chaihu-shugan-san.md) |
| [반하](../herbs/pinellia.md)·[후박](../herbs/magnolia-bark.md)·[자소엽](../herbs/perilla-leaf.md) | 행기산결·화담 | [반하후박탕](../formulas/banxia-houpo-tang.md) |
| [향부자](../herbs/cyperus.md)·[천궁](../herbs/chuanxiong.md) | 이기와 활혈을 연결하는 배합 | [시호소간산](../formulas/chaihu-shugan-san.md) · [월국환·육울탕](../formulas/yueju-wan.md) |

## 해표·외감·몸살 {#exterior-herbs}
...
→ [전체 본초 찾아보기](../herbs/index.md) · [본초 출처·현대 연구](../authority/herbs/index.md) · [복용 안전 안내](safety.md)
