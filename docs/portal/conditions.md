---
title: 증상·질환 탐색 안내
description: 환자 생활언어로 찾는 증상 허브와 진단명으로 찾는 질환 허브, R-code 한약 탐색과 임상 심화 자료의 역할을 구분해 안내합니다.
hide:
  - toc
---
<div class="ms-hero">
...
<a class="ms-card" href="/symptom-clinical/"><strong>📋 임상 심화 자료실</strong><span>위험신호·감별·치료전략·재평가</span></a>
</div>
...
| 현재 알고 있는 정보 | 대표 시작점 |
|---|---|
| 병명은 모르고 불편한 증상만 알아요 | [증상으로 찾기](/symptom-integrated/) |
| 진단명이나 의심 질환을 알고 있어요 | [질환별 보기](/conditions/) |
...
환자용 대표 입구는 **증상으로 찾기**와 **질환별 보기** 두 곳입니다. 세부 자료실은 대표 허브에서 연결된 다음 단계로 사용합니다.
