...
description: 치료·경과·근거 — 민성 한의학 아카이브의 관련 전문 지식과 연결되는 문서입니다.
---
# 치료·경과·근거
...
모든 환자에게 한약·침·전침·부항·온열·운동을 동시에 적용하는 것이 아니라 **현재 가장 큰 문제와 병증의 층위**를 먼저 정합니다.
...
**핵심:** 치료의 개수가 아니라 `현재 문제를 얼마나 정확히 겨냥하는가`가 우선입니다.
