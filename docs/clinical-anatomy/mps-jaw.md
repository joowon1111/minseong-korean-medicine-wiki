...
| 해부 항목 | 요점 |
|---|---|
| 주요 부착 | 광대활 → 아래턱뼈 가지·턱각 가쪽 |
| 기능 | 턱 닫기 |
| 신경지배 | 삼차신경 아래턱가지(V3) |

**평가:** 씹을 때의 피로·통증, 개구량, 이악물기와의 관계를 봅니다. 촉진한 부위와 환자가 느낀 통증 부위를 각각 기록합니다.

**함께 구분할 것:** 치아·치주 질환, 침샘 문제, 턱관절 자체의 통증과 구분합니다.

[그림에서 보기](../assets/mps-atlas/jaw.svg#masseter)
...
| 해부 항목 | 요점 |
|---|---|
| 주요 부착 | 관자오목·측두근막 → 아래턱뼈 근육돌기 |
| 기능 | 턱 닫기; 뒤섬유는 턱 뒤당김 |
| 신경지배 | V3의 깊은관자신경 |

**평가:** 관자 통증이 씹기·개구·이악물기에 따라 달라지는지 확인하고, 머리 통증의 시간 양상을 함께 묻습니다.

**함께 구분할 것:** 새로 생긴 관자 통증에 시각 변화나 전신 증상이 동반되면 근육통으로 단정하지 않습니다.
...
[UAMS 머리·목 근육 해부표](https://medicine.uams.edu/neuroscience/education/medical-school-courses/human-structure-module/anatomy-tables/muscle-tables/muscles-of-the-head-and-neck/).
