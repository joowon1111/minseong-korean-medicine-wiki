...
| 해부 항목 | 요점 |
|---|---|
| 주요 부착 | 위팔뼈 가쪽위관절융기 공통폄근힘줄 → 제3손허리뼈 바닥 |
| 기능 | 손목 폄·노쪽 치우침 |
| 신경지배 | 요골신경 깊은가지 계통 |

**평가:** 짧은노쪽손목폄근이라고도 합니다. 쥐기와 저항성 손목 폄에서 힘줄 부착부 통증인지 근육 부위 통증인지 비교합니다.

**함께 구분할 것:** 외측상과 힘줄병과 요골터널·뒤뼈사이신경 문제를 구별합니다.

[그림에서 보기](../assets/mps-atlas/forearm.svg#ecrb)
...
| 해부 항목 | 요점 |
|---|---|
| 주요 부착 | 안쪽위관절융기·자뼈 갈고리돌기 → 노뼈 중간 가쪽 |
| 기능 | 아래팔 회내 |
| 신경지배 | 정중신경 |

**평가:** 원엎침근이라고도 합니다. 반복해서 손바닥을 아래로 돌릴 때의 통증과 손 감각 변화를 함께 봅니다.

**함께 구분할 것:** 정중신경이 두 갈래 사이를 지납니다. 손 저림은 원회내근 주변과 손목터널 등 경로를 나누어 평가합니다.
...
[NCBI 짧은노쪽손목폄근 해부](https://www.ncbi.nlm.nih.gov/books/NBK539719/) · [UAMS 상지 근육 해부표](https://medicine.uams.edu/neuroscience/education/medical-school-courses/human-structure-module/anatomy-tables/muscle-tables/muscles-of-the-upper-limb/).
