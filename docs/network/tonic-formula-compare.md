...
| [귀용탕·귀룡탕](../formulas/gwiyong-tang.md) | 녹용·당귀·황기 등 + 소화 관련 약재; 수록형에 따라 다름 | 보익과 소화 상태를 함께 고려 | 소아·성인의 임상 가감 사례이며 보편적 성장 처방은 아님 |
...
## 처방명만 비교하지 말고 품질·용량·출전까지 보기 {#_7}

같은 보익 처방도 **원전의 구조, 약재 비율, 제형, 탕전량, 원료 품질, 환자별 가감**에 따라 실제 처방의 성격이 달라질 수 있습니다.

예를 들어 [익기보혈탕](../formulas/ikgi-bohyeol-tang.md#clinical-reference-variant)은 『우수경험방집』과 김정제 처방을 소개한 임상자료의 구성을 나누어 보아야 합니다. [귀용탕·귀룡탕](../formulas/gwiyong-tang.md#adult-variant)도 소아형과 성인 가감형을 단순한 용량 차이로 취급하지 않습니다. 임상 메모의 호전 경험과 특정 제제의 비교 임상시험은 근거의 성격이 다르므로, 처방 이름만 같다고 연구 결과를 옮기지 않습니다.
