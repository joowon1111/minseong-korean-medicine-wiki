...
**처방명에서 출발해 중심 변증과 관련 증상을 비교하는 지도**입니다. 표의 증상 링크는 감별과 상담 내용을 더 읽는 입구이며, 해당 증상이 있으면 그 처방을 복용하라는 뜻은 아닙니다. 같은 피로·불면·통증이라도 식사·수면·한열·허실과 동반 증상에 따라 검토할 방향이 달라집니다.

구성부터 확인하려면 [본초→방제 역탐색](herb-to-formula-map.md), 증상과 치료 선택부터 읽으려면 [질환·증상→치료 임상 지도](condition-to-treatment-map.md)를 이용합니다.

## 보기·기혈쌍보 {#_2}

[기허](../diagnostics/qi-deficiency.md)와 [혈허](../diagnostics/blood-deficiency.md)는 서로 다른 변증 개념이며, 현대의 빈혈 진단과도 구분합니다. 피곤하다는 말 하나보다 식사량·소화·땀·창백·심계·회복 양상을 함께 봅니다.

| 처방 | 중심 변증·비교할 단서 | 관련 증상·상담 문서 |
|---|---|---|
| [사군자탕](../formulas/sijunzi-tang.md) | 비위기허, 식욕과 기력 저하를 받치는 보기의 기본형 | [성인 식욕저하](../conditions/poor-appetite-adult.md) |
| [육군자탕](../formulas/liujunzi-tang.md) | 비위기허에 담습·메스꺼움·그득함이 함께 있는 맥락 | [기능성 소화불량](../conditions/functional-dyspepsia.md) |
| [보중익기탕](../formulas/buzhong-yiqi-tang.md) | 비위기허·중기하함을 살피는 보기승양의 방향 | [피로·기력회복](../conditions/energy-recovery.md) |
| [귀비탕](../formulas/guibi-tang.md) | 심비양허, 피로·식욕저하와 불면·심계·건망의 동반 | [불면](../conditions/insomnia.md)·[두근거림](../conditions/palpitation.md) |
| [팔물탕](../formulas/bazhen-tang.md) | 사군자탕과 사물탕의 골격을 합친 기혈쌍보 | [병후 회복](../conditions/post-hospitalization-recovery.md) |
| [십전대보탕](../formulas/shi-quan-da-bu-tang.md) | 기혈양허에 냉감·오래된 쇠약을 함께 보는 온보의 방향 | [노인보약](../conditions/elderly-tonic.md)·[수술 후 회복](../conditions/postoperative-recovery.md) |

소화 증상이 갈림점이면 [사군자탕과 육군자탕](../compare/sijunzi-vs-liujunzi.md), 보기와 기혈쌍보의 차이가 궁금하면 [보중익기탕과 십전대보탕](../compare/buzhong-vs-sipjeondaebo.md)을 비교합니다. 처방의 구성 계보는 [보기·기혈쌍보 처방 계보](tonic-formula-lineage.md)에 정리되어 있습니다.

## 허손·회복 {#_3}

회복을 목표로 한다는 공통점만으로 처방을 바꾸어 쓸 수는 없습니다. 정혈·기음·소화 상태와 함께 제형·성분을 비교합니다.

| 처방 | 중심 구조·비교할 단서 | 관련 증상·상담 문서 |
|---|---|---|
...
[담음](../diagnostics/phlegm-fluid.md)은 소화기 질환명 하나와 같은 뜻이 아닙니다. 소화불편이 중심인지, 비위기허가 바탕인지, 수면·심계나 한열착잡이 함께 있는지 나누어 봅니다. 육군자탕의 기본 위치는 위의 보기·기혈쌍보 표에서 확인할 수 있습니다.
...
통증 부위만으로 처방을 정하지 않습니다. 외상 여부, 냉감·무거움, 고정성 압통, 근육 경련, 오래된 허약과 기능 저하가 각각 어떤 비중인지 비교합니다.
...
고방은 앞의 분류와 달리 **고전적 병증과 처방 구조를 기준으로 묶은 범주**입니다. 현대의 감기·비염·부종 같은 질환명과 일대일로 대응하지 않으며, 표리·한열·땀·갈증·수음의 조합을 먼저 읽습니다.

| 처방 | 고전적 맥락·비교할 단서 | 이어서 읽을 문서 |
|---|---|---|
...
각 처방의 고전 설명과 현대 연구는 대상·구성·평가지표를 구분해 읽습니다. 원문에서 연구로 넘어가는 방법은 [고전→현대 연구 연결](classic-to-evidence-map.md), 전체 관계는 [통합 한의학 지식 그래프](integrated-knowledge-graph.md)를 참고합니다.
