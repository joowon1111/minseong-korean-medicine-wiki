...
2024년 umbrella review는 침과 placebo를 비교한 **11개 systematic review/meta-analysis, 총 8,399명**의 자료를 종합했다. 통증과 피로에서 통계적 차이가 보고됐지만 근거 확실성은 낮거나 매우 낮았고, 임상적 중요성에 대해서는 신중한 해석이 필요하다고 평가했다.
...
## 해석
섬유근육통은 증상이 복합적이므로 통증 한 지표만이 아니라 피로·수면·기능·삶의 질을 함께 보는 것이 중요하다. 연구 결과가 긍정적인 영역이 있지만 placebo 비교와 근거 확실성까지 함께 해석한다.
