---
title: 출처·근거 카드
description: 질환·한약처방·본초·침·약침의 전통적 맥락과 사람 대상 임상연구, PMID·DOI를 표준 형식으로 연결하는 근거카드 도서관입니다.
tags: [출처, 임상근거, 질환, 본초, 방제, 침, 약침, PMID, DOI]
status: 검토완료
...
| 찾는 내용 | 근거카드 |
|---|---|
| 불면·요통·소화불량·비염 등 질환별 연구 | [질환별 현대 임상근거](conditions/index.md) |
| 한약과 처방별 임상연구 | [한약·처방 현대 임상근거](formulas/herbal-formula-evidence-hub.md) |
| 녹용·인삼·황기·당귀 등 본초별 연구 | [본초 근거카드](herbs/index.md) |
| 침 치료의 임상시험과 프로토콜 | [침 치료 근거카드](acupuncture.md) |
| 약침의 성분·용량·시술과 임상시험 | [약침 근거카드](pharmacopuncture.md) |
| 공진단·경옥고 등 대표 보익 처방 | [공진단](gongjin-dan.md) · [경옥고](gyeongok-go.md) |
...
1. 환자가 찾는 증상과 현대 질환의 임상 맥락
2. 위험신호와 필요한 감별
3. 한의학적 병증·변증·치법
4. 본초·처방 구성 또는 경혈·자극방법
5. 사람 대상 임상시험과 종합연구
6. 대상자·용량·치료기간·비교군
7. 긍정적으로 관찰된 증상·기능 변화
8. 안전성과 치료 후 재평가
9. PMID·DOI 및 기존 지식망

## 각 영역의 역할

- **근거카드:** 질환·치료별 핵심 임상근거 요약
- **연구 데이터베이스:** RCT·메타분석·참고문헌 상세 목록
- **근거 읽는 법:** 연구설계와 논문 해석의 표준
- **임상 적용 심화:** 연구 대상과 현재 환자를 비교해 치료계획으로 연결
