...
이 허브는 한약재 이름과 성분을 나열하는 곳이 아니라 **본초의 기원·약용부위 → 전통적 역할 → 처방 속 배합 → 현대 성분·기전 연구 → 사람 대상 임상근거**를 구분해 연결하는 출발점입니다.

여기서 **효능**은 본초가 전통적 병증·병기를 다루는 작용 방향이고, **주치**는 그 효능을 적용해 온 구체적인 증후 범위입니다. 현재의 효능 분류는 고전의 기미·독성·주치 기록과 처방 경험, 후대 병기·치법 해석, 근현대 교육·표준화를 거쳐 형성된 공통 언어입니다. 현대 약리작용이나 특정 검사 지표와 바로 같은 뜻으로 사용하지 않습니다.

보기·청열·활혈 같은 공통 정의와 현대 연구 지표의 관계는 [본초 효능·주치 표준](../../herbal-integrated/efficacy-indication-standard.md)에서, 분류가 형성된 과정은 [효능 용어는 어떻게 형성되었나요?](../../herbal-integrated/efficacy-indication-standard.md#history)에서 확인합니다. 특히 청열약은 [청열사화·청열조습·청열해독·청열량혈·청허열 비교](../../herbal-integrated/heat-clearing-herbs.md)로 나누어 읽습니다.

한약은 여러 본초가 배합된 처방으로 연구되는 경우가 많습니다. 따라서 개별 본초의 성분·전임상 결과를 완성 처방의 임상효과와 같게 보지 않고, 연구가 어느 단계에 있는지 함께 표시합니다.

## 무엇을 확인하려고 하나요?

| 궁금한 내용 | 먼저 볼 곳 |
|---|---|
| 대표 본초의 전통적 역할과 주요 연구 | 아래 **대표 본초 심화 근거 카드** |
| 피로·불면·소화·수분대사처럼 임상 목적에서 찾기 | **증상과 치료 방향으로 찾기** |
| 본초가 어떤 처방에 들어가는지 찾기 | [본초→방제 역탐색](../../network/herb-to-formula-map.md) |
| 비슷한 약재의 차이 비교 | [주요 본초 비교·감별](../../herbal-integrated/herb-comparisons.md) |
| 고전 출전과 현대 연구를 함께 확인 | [본초·방제 근거·출전](../../herbal-integrated/evidence.md) |
| 기원·법제·복용약 등 안전성 확인 | [본초·방제 안전·복용 주의](../../herbal-integrated/safety.md) |

## 대표 본초 심화 근거 카드

현재 대표성이 높고 처방 연결이 많은 **12개 본초**를 우선 표준 카드로 정리했습니다. 모든 본초명은 상세 페이지로 연결됩니다.

| 본초 | 전통적으로 보는 중심 역할 | 현대 연구에서 주로 보는 축 | 심화 카드 |
|---|---|---|---|
| 녹용 | 보신양·익정혈·강근골 | 아미노산·펩타이드·단백질, 골·연골·회복 연구 | [녹용 근거 카드](velvet-antler.md) |
| 인삼 | 대보원기·보비익폐 | ginsenoside, 피로·활동기능 관련 사람 연구 | [인삼 근거 카드](ginseng.md) |
| 황기 | 보기승양·고표 | astragaloside·다당류·flavonoid, 면역·대사 연구 | [황기 근거 카드](astragalus.md) |
| 당귀 | 보혈·활혈 | ligustilide·ferulic acid·다당류 | [당귀 근거 카드](angelica.md) |
| 백작약 | 양혈렴음·유간지통 | paeoniflorin·monoterpene glycosides | [백작약 근거 카드](white-peony.md) |
| 천궁 | 활혈행기·거풍지통 | phthalide·phenolic acid, 순환·통증 연구 | [천궁 근거 카드](chuanxiong.md) |
| 산조인 | 양심안신 | jujuboside·spinosin, 수면 관련 사람 연구 | [산조인 근거 카드](ziziphus-seed.md) |
| 맥문동 | 양음생진·윤폐 | steroidal saponin·다당류, 호흡기·진액 연구 | [맥문동 근거 카드](ophiopogon.md) |
| 산수유 | 보익간신·수렴고삽 | iridoid glycosides·loganin·morroniside | [산수유 근거 카드](cornus-fructus.md) |
| 산약 | 보비·보폐·보신 | 다당류와 가공·추출에 따른 성분 연구 | [산약 근거 카드](dioscorea.md) |
| 택사 | 이수삼습·설열 | alisol 계열 triterpenoid, 수분·대사 연구 | [택사 근거 카드](alisma.md) |
| 목단피 | 청열량혈·활혈거어·퇴허열 | paeonol·paeoniflorin, 염증·순환 연구 | [목단피 근거 카드](moutan.md) |
...
| 수분대사·습 | 붓고 무거움, 소변과 수분대사 불편, 담음 | [택사](alisma.md) · [복령](../../herbs/poria.md) · [저령](../../herbs/polyporus.md) · [의이인](../../herbs/coix.md) | [오령산](../../formulas/wuling-san.md) · [육미지황환](../formulas/liuwei-dihuang-wan.md) |
| 소화·담음 | 더부룩함, 명치 답답함, 메스꺼움, 식욕저하 | [반하](../../herbs/pinellia.md) · [진피](../../herbs/citrus-peel.md) · [후박](../../herbs/magnolia-bark.md) · [사인](../../herbs/amomum.md) | [반하사심탕](../formulas/banxia-xiexin-tang.md) · [육군자탕](../../formulas/liujunzi-tang.md) |

같은 증상도 기허·혈허·음허·담음·기체·어혈처럼 배경이 다를 수 있습니다. 대표 본초 표는 처방을 바로 결정하는 목록이 아니라 **변증과 배합 구조를 찾아가는 탐색 지도**입니다.

## 사람 대상 근거가 있는 본초는 어떻게 읽나요?

개별 본초 자체를 사람에게 투여한 연구가 확인되면 성분·기전 연구와 별도로 표시합니다.

| 본초 | 확인된 사람 대상 근거의 예 | 읽을 때 확인할 점 |
|---|---|---|
| [인삼](ginseng.md) | 피로 관련 임상시험을 종합한 체계적 문헌고찰 — [PMID 29624410](https://pubmed.ncbi.nlm.nih.gov/29624410/) | 인삼 종, 추출물 표준화, 피로 원인과 복용기간 |
| [산조인](ziziphus-seed.md) | 수면 관련 9개 무작위시험·905명 메타분석 — [PMID 37014010](https://pubmed.ncbi.nlm.nih.gov/37014010/) | 단독 추출물인지 복합 처방인지, 주관적 수면지표와 기간 |
...
| 처방 구조 | 구성의 중심 | 본초 역할을 읽는 핵심 |
|---|---|---|
| 사군자탕 | 인삼·백출·복령·감초 | 보기와 건비, 수분대사와 조화를 함께 구성 |
| 사물탕 | 숙지황·당귀·백작약·천궁 | 보혈·양혈과 혈행의 균형 |
| 육미지황환 | 숙지황·산수유·산약 + 택사·목단피·복령 | 보익하는 세 본초와 조절하는 세 본초의 균형 |
| 생맥산 | 인삼·맥문동·오미자 | 보기·양음생진·수렴을 함께 배치 |
| 공진단 | 녹용·당귀·산수유·사향 | 보익·보혈·수렴과 방향성의 결합 |

→ [임상 핵심 본초 배합 지도—약대](../../network/herb-pair-combinations.md) · [본초→방제 역탐색](../../network/herb-to-formula-map.md)
...
개별 본초 사람 대상 연구
  ↓
완성 처방의 임상시험·체계적 문헌고찰
```

- **성분이 확인되었다**는 말은 그 성분의 사람 대상 치료효과가 확정되었다는 뜻이 아닙니다.
- **전임상에서 작용이 관찰되었다**는 결과는 임상 연구의 가능성과 기전을 이해하는 자료입니다.
- **사람 대상 연구**는 대상자의 진단·변증, 원료, 추출법, 용량, 제형, 복용기간과 비교군을 함께 봅니다.
- **복합처방 연구**의 결과를 구성 본초 하나의 효과로 그대로 돌리지 않습니다.

## 기원·품질과 안전성

같은 이름의 본초도 기원식물·약용부위·산지·수확시기·수치와 법제·추출법에 따라 성분 구성이 달라질 수 있습니다. 연구 논문과 실제 처방을 연결할 때는 원료 동정, 지표성분, 제형과 1일 용량을 확인합니다.

임신·수유, 수술 전후, 간·신장 기능 저하, 항응고제·항혈소판제 등 복용약이 있는 경우에는 단일 약재명보다 **전체 처방 구성과 용량**을 기준으로 확인합니다.

→ [본초·방제 안전·복용 주의](../../herbal-integrated/safety.md) · [PMID·DOI 읽는 법](../../evidence-guide/pmid-doi.md)

## 더 깊게 보기

- [본초학 전체 보기](../../herbs/index.md)
- [본초 찾기—치법에서 처방까지](../../herbal-integrated/herbs.md)
- [본초·방제 근거·출전](../../herbal-integrated/evidence.md)
- [한약 연구를 읽는 법](../../evidence-integrated/herbal-evidence.md)
- [한약·처방 현대 임상근거 허브](../formulas/herbal-formula-evidence-hub.md)
- [전체 출처·근거 허브](../index.md)
