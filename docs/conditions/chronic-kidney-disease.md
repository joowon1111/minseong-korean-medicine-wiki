...
!!! tip "이 문서의 핵심"
    **처음 이상이 발견되었을 때 원인을 확인하고 혈압·혈당·단백뇨·약물·생활습관을 관리하여 신장기능 저하 속도를 늦추는 것**이 중요합니다. 한의치료도 초기·중기부터 피로·식욕·수면·부종감·통증과 전신 상태를 함께 관리합니다.
...
한의치료는 신장기능 수치와 투석 계획을 함께 확인하면서 다음과 같은 증상·기능·삶의 질 목표에 적용합니다.
...
침치료는 CKD와 함께 나타나는 피로, 수면장애, 소화저하, 근골격계 통증, 가려움과 자율신경 긴장을 관리하는 데 활용하고 eGFR·혈압·부종 등 신장 지표를 함께 추적합니다.
...
이 단계의 한의치료 목표는 피로·식욕·수면·가려움·통증을 관리해 삶의 질과 일상기능을 높이는 것입니다. 투석 일정, 건체중, 칼륨·인·혈압, 동정맥루와 복용약을 투석팀과 공유하며 안전하게 시행합니다.
...
!!! note "의료 안내"
    이 문서는 일반적인 건강정보입니다. CKD의 원인과 단계에 따라 필요한 치료와 식사가 크게 다르므로, 개인별 진단·처방에 맞춰 신장내과 진료와 개별화된 한의치료를 함께 계획하세요.
