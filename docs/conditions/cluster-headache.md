...
!!! tip "핵심 답변"
    한쪽 눈 주위가 15~180분 동안 견디기 어려울 정도로 아프고, 같은 쪽 눈물·충혈·코막힘·콧물·눈꺼풀 처짐이 동반되며 가만히 있기 어려우면 군발두통을 의심합니다. 처음 겪는 발작이나 평소와 다른 눈·신경 증상은 이차 원인을 먼저 배제해야 합니다. 진단 뒤에는 처방된 고유량 산소와 피하·비강 트립탄 같은 빠른 급성기 치료, 군발기 전체를 줄이는 예방치료를 별도로 준비합니다. 한약·침은 이 치료를 미루는 대체수단이 아닙니다.
...
난치성 군발두통에서는 신경차단술이나 비침습 미주신경자극 등 전문치료를 검토할 수 있습니다. 침의 전기자극과 의료기기 기반 신경조절술은 같은 치료가 아닙니다.
...
전통의학의 편두통·두풍·두통 변증은 통증의 냉열, 고정성, 상열감, 담음, 수면·소화·피로를 구분하는 틀입니다. 현대의 **삼차자율신경두통 진단을 대체하거나 급성 안과·혈관 질환을 배제하는 기준은 아닙니다.**

| 변증의 방향 | 함께 보는 양상 | 치료 구성에서의 의미 |
|---|---|---|
| 간화·풍화상요 | 눈 충혈·열감·번조, 스트레스와 상열감 | 열·긴장 양상을 보되 군발두통의 자율신경 증상과 동일시하지 않음 |
| 담열·담습 | 머리 무거움·오심·흉민·소화저하 | 군발두통 외 편두통·소화 증상 중첩을 함께 평가 |
| 기체·어혈·경락불통 | 위치가 고정되고 찌르는 통증, 오래 반복된 통증 | 통증 양상과 기존 약물·혈관 위험을 함께 확인 |
| 기혈허·음허 | 군발기 뒤 심한 피로·불면·회복 지연 | 급성 발작 억제보다 군발기 이후 회복 목표를 분리 |

### 한약

두면부 풍사와 반복 두통에는 [천궁다조산](../formulas/chuanxiong-chatiao-san.md)·[청상견통탕](../formulas/qingshang-juantong-tang.md), 간양·상열 양상에는 [천마구등음](../formulas/tianma-gouteng-yin.md) 같은 처방 구조를 비교할 수 있습니다. 그러나 이 처방들이 군발두통의 산소·트립탄과 동등한 급성 효과가 입증됐다는 뜻은 아닙니다.
...
침은 군발두통 자체에 한정한 신뢰도 높은 임상근거가 부족합니다. 시행한다면 표준 급성·예방치료를 유지한 상태에서 목·어깨 긴장, 불면, 군발기 뒤 피로처럼 함께 관리할 목표를 명확히 정합니다.

- 합곡(LI4)·태충(LR3), 외관(TE5)·족임읍(GB41), 풍지(GB20) 등은 변증과 동반 증상에 따라 구성할 수 있습니다.
- 통증이 극심한 발작 중 산소·트립탄 대신 침치료를 기다리지 않습니다.
- 눈확 안쪽·깊은 안면부를 강하게 자극하지 않고 안구·혈관·신경공의 해부학적 안전을 우선합니다.
- 감각저하·새 동공 이상·시력 변화가 있으면 국소 침치료보다 원인 평가가 먼저입니다.

전침의 주파수·강도에 따른 군발두통 효과는 확립되지 않았습니다. 심박조율기 등 전기자극 금기를 확인하고, 자율신경 증상이나 심한 초조를 전기자극으로 억누르려 하지 않습니다.

### 약침

군발두통 발작을 중단하거나 예방한다는 약침의 표준화된 근거는 확립되지 않았습니다. 안와·관자·경동맥 주변의 깊은 약침은 해부학적 위험이 크므로 피하고, 성분·알레르기·출혈 위험과 병용약을 확인합니다. 약침을 고려하더라도 치료 목표와 중단 기준을 미리 정합니다.
...
### 침이나 한약만으로 급성 발작을 버틸 수 있나요?

권하지 않습니다. 군발두통은 매우 빠르고 심하게 진행하므로 산소·트립탄 같은 근거 기반 구조치료를 우선 준비합니다. 한의치료를 병행할 때도 발작 횟수·수면·동반 긴장·약물 부작용 등 구체적인 보조 목표를 정하고, 효과가 없으면 지연 없이 계획을 바꿉니다.
