...
!!! note "한약치료의 위치"
    ACE억제제·ARB, SGLT2억제제와 혈압·혈당 관리에 한약치료를 병행하면서 uACR·eGFR·칼륨·간기능과 이상반응을 같은 조건에서 추적합니다.
...
침치료는 피로·수면장애·소화저하·부종감·신경병증성 저림과 통증을 관리하는 데 활용합니다. 족삼리(ST36), 삼음교(SP6), 음릉천(SP9), 태계(KI3), 신수(BL23), 관원(CV4) 등을 상태에 맞게 선별하고 신장기능·부종·감각 상태를 함께 추적합니다.
...
!!! note "의료 안내"
    이 문서는 일반적인 건강정보입니다. 당뇨병성 콩팥병은 심혈관 위험과 연결되므로 개인별 진단·처방에 맞춰 내분비·신장 진료와 한의치료를 함께 계획하세요.
