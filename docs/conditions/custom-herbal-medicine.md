...
- 새로운 중증 위험신호가 있는 경우 원인평가 우선

## 한약·보약과 연결

맞춤한약은 같은 질환명이라도 환자의 증상조합·한열·허실·소화·수면·생활패턴에 따라 처방 구성이 달라질 수 있다는 한의학의 특징을 잘 보여주는 영역입니다.
...
처음 상담은 [증상·복용약·검사결과 준비 체크리스트](herbal-consultation-prep.md#visit-checklist)로 준비하고, 복용 뒤에는 [증상별 비교 항목과 재진 메모](herbal-followup.md#symptom-measures)로 경과를 이어서 확인할 수 있습니다.
