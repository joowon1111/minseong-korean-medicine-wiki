...
description: 회전근개 건병증과 부분·전층파열을 오십견·목디스크와 구분하고 초음파·MRI, 비수술 치료, 침·약침·한약과 근력 회복을 안내합니다.
tags: [회전근개파열, 회전근개건병증, 어깨통증, 팔들기통증, 어깨근력저하]
status: 검토완료
...
| 통증과 함께 스스로도 도움받아도 전반적으로 굳음 | [오십견](frozen-shoulder.md) | 수동 외회전·거상 제한 |
| 목에서 팔·손으로 뻗는 통증과 저림 | [목디스크](cervical-disc-herniation.md) | 목 자세, 감각·근력·반사 |
...
1. 팔을 스스로 드는 능동 ROM과 도움받아 움직이는 수동 ROM을 비교합니다.
2. 외전·외회전·내회전 힘과 통증 때문에 못 쓰는 것인지 실제 약화인지 구분합니다.
3. 견갑골의 들림·회전, 목과 흉추 자세, 삼각근과 이두근을 함께 봅니다.
4. 머리 감기·옷 입기·높은 선반·물건 들기·옆으로 눕기의 제한을 기록합니다.
5. 목에서 오는 신경근 통증과 손저림이 겹치는지 확인합니다.
...
[AAOS 회전근개파열 안내](https://www.orthoinfo.org/diseases--conditions/rotator-cuff-tears/)처럼 영상의 파열 크기만 보지 않고 나이·활동·증상 기간·실제 기능을 함께 해석합니다.
...
침치료는 극상근·극하근·견갑하근·소원근과 삼각근, 이두근 장두, 견갑대의 압통·근력·움직임을 평가해 구성합니다. 견우(LI15)·견료(TE14)·천종(SI11)·거골(LI16)과 견갑·상완의 아시혈 등을 증상에 맞춰 활용할 수 있습니다. [어깨·견갑대 MPS 아틀라스](../clinical-anatomy/mps-shoulder.md)에서 근육별 연관통과 기능을 확인할 수 있습니다.
...
|---|---|---|
| 외상 뒤 고정통·압통·멍 | 활혈거어·통락 | [당귀수산](../formulas/danggui-susan.md) 계열 |
| 오래된 통증과 풍습·어혈, 뻣뻣함 | 거풍습·활혈통락 | [소경활혈탕](../formulas/shujing-huoxue-tang.md) 계열 |
| 냉감과 무거움·여러 부위의 한습 | 산한제습·통락 | [오적산](../formulas/wuji-san.md) 계열 |
| 만성 경과와 피로·회복 저하 | 익기양혈·통락 | 기혈 상태에 따른 보익 처방 검토 |

현대 침·약침 연구는 [회전근개 질환 임상근거](../authority/conditions/rotator-cuff-disease.md)에서 대상군·중재·통증과 기능 결과를 구분해 볼 수 있습니다.
...
- [오십견](frozen-shoulder.md)
- [목디스크·팔저림](cervical-disc-herniation.md)
- [팔을 머리 위로 들 때 통증](overhead-shoulder-pain.md)
- [어깨·견갑대 MPS 아틀라스](../clinical-anatomy/mps-shoulder.md)
- [회전근개 질환 임상근거](../authority/conditions/rotator-cuff-disease.md)
- [어깨 경혈 구성](../acupuncture-integrated/points-for-neck-shoulder.md)

## 주요 근거

- American Academy of Orthopaedic Surgeons. [Rotator Cuff Tears](https://www.orthoinfo.org/diseases--conditions/rotator-cuff-tears/).
