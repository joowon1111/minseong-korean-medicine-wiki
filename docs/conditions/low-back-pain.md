...
→ [요통·디스크 한약 임상연구](../authority/formulas/musculoskeletal-herbal-evidence.md#low-back)

- **[당귀수산](../formulas/danggui-susan.md) 계열**: 급성 외상과 멍·부종을 동반한 어혈성 통증
...
다리 방사통이 있는 경우에는 [허리디스크 신전운동·스트레칭·재활](lumbar-disc-herniation.md#extension-rehab)에서 엎드려 쉬기부터 프레스업·서서 신전으로 진행하는 순서와 중심화·말초화 판정 기준을 확인할 수 있습니다. 협착증처럼 숙이거나 앉을 때 편한 유형에는 같은 신전운동을 일괄 적용하지 않습니다.
