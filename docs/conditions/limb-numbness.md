...
저림의 출발점과 방향을 구체적으로 기록하면 감별에 도움이 됩니다. 목·어깨에서 손가락으로 이어지면 [팔·손 저림](./arm-numbness.md), 허리·엉덩이에서 발로 내려가면 [발·하지 저림](./foot-numbness.md)에서 신경근·말초신경 분포를 더 자세히 볼 수 있습니다.

## 신경·혈관·전신 원인을 나누는 기준

| 구분 | 흔한 단서 | 평가의 초점 |
|---|---|---|
| 중추신경·척수 | 갑작스러운 편측 증상, 양손 서툼과 보행장애, 넓은 감각 변화 | 뇌혈관·척수 위험신호 |
| 신경근 | 목·허리에서 팔·다리로 뻗고 자세에 따라 변함 | 근력·반사·신경긴장검사, 필요 시 MRI |
| 말초신경 포착 | 특정 손가락·발가락 분포, 손목·팔꿈치·무릎·발목 자세 영향 | 압박 부위 진찰, 신경전도검사 |
| 다발신경병증 | 양쪽 손발 끝부터 대칭적, 화끈거림·야간 악화 | 혈당·약물·영양·장기기능과 신경전도 |
| 혈관 | 냉감·색 변화·부종·상처, 운동 시 통증 | 맥박·피부·발목상완지수 등 |

여러 원인이 겹칠 수 있으므로 ‘혈액순환’이나 ‘디스크’ 한 단어로 정리하지 않습니다. 특히 영상의 퇴행성 변화는 증상 없는 사람에게도 발견될 수 있어 신경학적 진찰과 일치 여부가 중요합니다.
...
[목디스크](cervical-disc-herniation.md) · [허리디스크](lumbar-disc-herniation.md) · [척추관협착증](lumbar-spinal-stenosis.md) · [손목터널증후군](carpal-tunnel.md)
