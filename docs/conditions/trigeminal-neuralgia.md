---
title: 삼차신경통·얼굴 전기통증
description: 세수·양치·말하기에 유발되는 한쪽 얼굴 전격통의 진단 단서, 삼차신경 분지, MRI·약물·수술과 한약·침 병행치료 및 경과 기록을 안내합니다.
tags: [삼차신경통, 안면통증, 얼굴전기통증, 신경병성통증, 침치료, 한약, 감별진단]
status: 검토완료
last_reviewed: 2026-09-20
---
# 삼차신경통·얼굴 전기통증

삼차신경통은 대개 **한쪽 얼굴의 삼차신경 분포에 전기 충격처럼 갑작스럽고 매우 강한 통증이 반복되는 질환**입니다. 세수·양치·면도·말하기·씹기·찬 바람처럼 원래 아프지 않아야 할 자극이 통증을 일으키기도 합니다. 치통이나 턱관절통증과 혼동하기 쉬우므로 통증 위치만이 아니라 **한 번의 지속시간, 통증 성질, 촉발 자극, 감각 변화**를 함께 봅니다.

!!! tip "핵심 답변"
    수초 안팎의 전격통이 같은 쪽 얼굴에 반복되고 가벼운 접촉으로 유발되면 삼차신경통을 먼저 감별합니다. 진단은 증상만 듣고 끝내지 않고 신경학적 진찰과 MRI 필요성을 평가하며, 약물치료가 기본입니다. 한약·침치료는 진단과 표준치료를 유지하면서 통증 발작, 동반된 저작근 긴장, 수면과 일상기능을 함께 관리하는 방향으로 병행합니다.

## 전형적인 통증을 알아보는 기준

[국제두통질환분류 ICHD-3](https://ichd-3.org/13-painful-cranial-neuropathies-and-other-facial-pains/13-1-trigeminal-neuralgia/)의 핵심 진단 특징은 다음과 같습니다.
...
통증이 오래됐다고 매번 같은 모습인 것은 아닙니다. 발작이 잦아지거나 지속시간이 길어질 수 있고, 전격통 사이에 묵직하거나 화끈거리는 통증이 남는 유형도 있습니다. 반대로 **하루 종일 넓고 모호하게 이어지는 얼굴통증만 있는 경우**에는 다른 안면통증 질환을 함께 살핍니다.
...
| **턱관절·저작근 통증** | 씹기·입 벌리기에 따라 변하는 둔통, 관절음·개구제한·근육 압통 | [턱관절장애 통합 안내](temporomandibular-disorder.md) |
| **대상포진 후 신경통** | 이전 수포 부위의 화끈거림·접촉통·감각 변화가 지속 | 피부병력과 [대상포진 후 신경통](postherpetic-neuralgia.md) |
| **[군발두통](cluster-headache.md)·짧은 삼차자율신경두통** | 눈 주위 통증과 눈물·충혈·코막힘·눈꺼풀 변화가 함께 반복 | 발작시간·빈도와 자율신경 증상 |
...
삼차신경통은 통증의 문진이 진단의 출발점입니다. 동시에 감각·각막반사·저작근 기능과 다른 뇌신경 이상을 확인합니다. [유럽신경학회 진료지침](https://pubmed.ncbi.nlm.nih.gov/30860637/)은 증상만으로 이차성 원인을 모두 배제할 수 없으므로 **삼차신경을 평가하는 고해상도 영상을 포함한 MRI를 진단 과정에 포함**하도록 권고합니다.
...
| 한의치료 | 발작 강도·빈도, 동반된 저작근 방어성 긴장, 수면·불안·섭식 저하를 함께 관리하는 병행 선택지 | 진단·MRI·필수 약물과 수술 평가를 대신하지 않으며 치료 반응을 같은 지표로 재평가 |
...
이러한 변증은 MRI에서 확인하는 신경혈관 압박이나 다발성경화증 같은 원인 분류를 대체하지 않습니다. 같은 삼차신경통이라도 다음 차이를 반영해 침 배혈과 한약 구성을 개별화하기 위한 임상 틀입니다.
...
침치료는 **발작 횟수·통증강도·촉발 범위와 식사·양치·수면 기능**의 변화를 목표로 합니다. 안면부 국소혈만 많이 자극하기보다 통증 분지, 감각검사, 저작근·경추 긴장과 전신 상태를 확인하여 원위혈과 안전한 국소혈을 조합합니다.
...
통증이 V3에 집중되면서 교근·측두근 압통과 이갈이가 겹친다면 [턱관절·저작근 평가](temporomandibular-disorder.md)를 병행합니다. 근육치료로 둔한 저작통은 줄어도 전형적인 접촉 유발 전격통이 남는다면 두 통증을 하나로 합치지 않습니다.

## 침치료 연구는 어디까지 확인됐나요?

현대 연구에서는 통증점수, 발작 빈도, 임상반응, 이상사건 등을 측정했습니다.

- [2023년 체계적 문헌고찰·메타분석](https://pubmed.ncbi.nlm.nih.gov/37159979/)은 **무작위시험 30편·2,295명**을 포함했습니다. 침치료군에서 통증점수·발작 빈도 등의 개선 신호가 보고됐지만, 주요 결과의 근거 확실성은 낮거나 매우 낮았습니다.
- [2026년 네트워크 메타분석](https://pubmed.ncbi.nlm.nih.gov/42524199/)은 **무작위시험 58편**에서 여러 침 관련 치료를 비교했습니다. 일부 침치료와 통상치료 병행군의 발작 빈도·증상 지표에서 긍정적 결과가 있었으나 연구 간 이질성이 크고 전반적인 근거 확실성이 낮아 결과를 신중하게 해석해야 합니다.

따라서 현재 연구는 침치료를 **표준 약물·전문의 평가와 함께 고려할 수 있는 보조 선택지**로 설명하는 데 활용합니다. 서로 다른 침법을 하나의 동일한 치료로 합치거나, 낮은 확실성의 간접 비교를 근거로 특정 침법이 약물이나 수술을 대체한다고 단정하지 않습니다.
...
이때는 진단이 맞는지, MRI가 적절한 뇌신경 영상으로 시행됐는지, 약물 조합 또는 수술·시술 상담이 필요한지를 다시 확인합니다. 보조치료를 오래 지속했다는 이유로 전문 치료의 시기를 늦추지 않습니다.
...
- [ICHD-3: Trigeminal neuralgia](https://ichd-3.org/13-painful-cranial-neuropathies-and-other-facial-pains/13-1-trigeminal-neuralgia/) — 진단 특징과 분류
- [European Academy of Neurology guideline on trigeminal neuralgia, 2019](https://pubmed.ncbi.nlm.nih.gov/30860637/) — MRI·약물·수술 권고
- [Acupuncture for the treatment of trigeminal neuralgia, 2023](https://pubmed.ncbi.nlm.nih.gov/37159979/) — 30개 무작위시험 체계적 문헌고찰
- [Acupuncture-related therapies for primary trigeminal neuralgia, 2026](https://pubmed.ncbi.nlm.nih.gov/42524199/) — 58개 무작위시험 네트워크 메타분석
...
<script type="application/ld+json">
{
  ...
  "@type": "MedicalWebPage",
  "name": "삼차신경통·얼굴 전기통증",
  "description": "삼차신경통의 진단 단서, 감별, MRI·약물·수술과 한의 병행치료 및 경과 기록을 안내합니다.",
  "url": "https://wiki.minseong.co.kr/conditions/trigeminal-neuralgia/",
  "inLanguage": "ko-KR",
