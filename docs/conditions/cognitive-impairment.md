---
title: 기억력저하·경도인지장애·건망증
description: 건망증과 경도인지장애·치매를 구분하고 가역적 원인, 한의학적 변증, 한약·침구치료와 인지·생활기능 추적을 안내합니다.
tags: [기억력저하, 경도인지장애, 건망증, 치매예방, 노인건강, 한약, 침]
status: 검토완료
...
기억이 예전 같지 않다는 느낌은 수면부족·우울·불안·약물·청력저하부터 경도인지장애와 치매까지 여러 원인에서 생깁니다. 핵심은 검사 점수 하나가 아니라 **최근 변화, 일상 독립성, 기억 외 언어·판단·공간능력, 보호자가 관찰한 변화**를 함께 보는 것입니다.
...
- National Institute on Aging. [Assessing Cognitive Impairment in Older Patients](https://www.nia.nih.gov/health/health-care-professionals-information/assessing-cognitive-impairment-older-patients).

## 관련 문서

[수면·정서·신경 허브](../pillar/sleep-neuro.md) · [브레인포그](brain-fog.md) · [노인 불면](poor-sleep-elderly.md) · [청력저하](hearing-loss.md) · [대사·건강검진 허브](../pillar/metabolic-checkup.md)
