...
한의학 진료에서는 월경주기와 통증·출혈 양상, 냉증·소화·수면·피로, 정액검사와 난임검사 결과, 현재 진행 중인 배란유도·인공수정·시험관 일정을 함께 살펴 한약·침·뜸과 생활관리를 구성합니다. 목표는 검사와 보조생식술 일정에 맞춰 **자연임신을 준비하거나 난임치료를 받는 동안 전신 상태와 치료 과정을 안정적으로 관리하는 것**입니다.
...
- **조경종옥탕 계열**: 월경주기와 하초 한·기혈실조를 함께 보는 임신준비 처방
- **육린주 계열**: 기혈양허·신허·충임부족과 전신 허손이 중심인 임신준비
- **개울종옥탕 계열**: 간울기체와 월경·배란 리듬의 변동이 중심인 임신준비
...
침 치료는 월경통과 골반 긴장, 스트레스·수면, 배란유도 중 불편감과 시험관 치료 과정의 컨디션 관리를 위해 활용할 수 있습니다. IVF 과정에서 침을 함께 적용한 연구의 임신·출생 결과는 연구 설계와 시술 시점에 따라 차이가 있으므로, 치료 목적과 일정을 개인별로 정하고 경과를 확인합니다.
...
- [육린주](../formulas/yulin-zhu.md)
- [개울종옥탕](../formulas/kaiyu-zhongyu-tang.md)
