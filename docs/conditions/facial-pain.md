...
다음 상황에서는 침·한약이나 근육치료를 먼저 시작하기보다 해당 전문 진료를 우선합니다.
...
이러한 변증은 치아 감염·삼차신경 압박·눈 질환 같은 현대 진단을 대신하지 않습니다. **같은 얼굴 위치에 생긴 서로 다른 통증을 구분한 뒤** 침 배혈과 한약 구성을 개별화하기 위한 층위입니다.
