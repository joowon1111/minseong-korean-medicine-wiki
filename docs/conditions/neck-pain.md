...
→ [목·경추 한약 임상연구](../authority/formulas/musculoskeletal-herbal-evidence.md#neck)

처방은 “목통증”이라는 이름보다 발병 시점과 변증에 따라 선택합니다.

- **갈근탕 계열**: 감기 초기와 함께 뒷목이 뻣뻣하고 오한·두통이 동반되는 표증
- **오적산 계열**: 냉증과 한습, 몸이 무겁고 여러 부위가 함께 뻣뻣한 양상
- **[회수산](../formulas/huishou-san.md) 계열**: 급성 목결림·회전 제한과 풍한·기체성 견배부 긴장
- **[당귀수산](../formulas/danggui-susan.md) 계열**: 교통사고나 염좌 뒤 멍·부종·고정통 등 어혈이 뚜렷할 때
...
팔·손 저림이 있는 상태에서 목을 무조건 젖히는 것은 적절하지 않을 수 있습니다. [목디스크 신전운동·스트레칭·재활](cervical-disc-herniation.md#extension-rehab)에서 턱 당기기와 소범위 신전을 구분하고, 중심화·말초화에 따라 진행하는 방법을 확인할 수 있습니다.
