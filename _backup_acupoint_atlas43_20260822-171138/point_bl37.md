---
title: 은문 BL37
description: 은문 BL37 표준 위치·취혈·임상 지식망
status: 검토완료
...
넓적다리 뒤쪽면, 넙다리두갈래근(biceps femoris muscle)과 반힘줄모양근(semitendinosus muscle)의 사이,
엉덩이주름(gluteal fold)에서 아래쪽으로 6寸.

### 실제 취혈 포인트

承扶(BL36)와 委中(BL40)을 연결하는 선의 중점에서 위쪽으로 1寸 지점에서 취혈한다.
