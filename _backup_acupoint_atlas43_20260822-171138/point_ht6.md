---
title: 음극 HT6
description: 음극 HT6 표준 위치·취혈·임상 지식망
status: 검토완료
...
콩알뼈(pisiform bone) 몸 쪽 모서리 노쪽에서 몸 쪽으로 0.5寸, 즉 神門(HT7)에서 몸 쪽으로 0.5寸에서 취혈한다. 자뼈머리(head of the ulna)의 먼 쪽 모서리와 같은 높이에 위치한다.
