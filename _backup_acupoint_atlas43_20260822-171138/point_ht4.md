---
title: 영도 HT4
description: 영도 HT4 표준 위치·취혈·임상 지식망
status: 검토완료
...
콩알뼈(pisiform bone) 위모서리 노쪽에서 몸쪽으로 1.5寸, 즉 神門(HT7)에서 몸쪽으로 1.5寸에서 취혈한다. 자뼈머리(head of the ulna)의 위모서리 및 列缺(LU7)과 같은 높이에 위치한다.
