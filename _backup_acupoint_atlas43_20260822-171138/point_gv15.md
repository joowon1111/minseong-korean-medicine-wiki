---
title: 아문 GV15
description: 아문 GV15 표준 위치·취혈·임상 지식망
status: 검토완료
...
목 뒤부위, 뒤정중선(posterior median line), 둘째 목뼈 가시돌기(spinous process of the 2nd cervical vertebra)
위쪽 오목한 곳.

### 실제 취혈 포인트

風府(GV16)를 먼저 취혈하고, 風府(GV16) 아래쪽 0.5寸에서 취혈한다.
...
- 斜刺 0.5～1寸 (口部와 耳垂의 水平位를 기준으로 刺入)
