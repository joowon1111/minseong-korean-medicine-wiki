...
$bk="_backup_reasoning_safety_evidence42_"+(Get-Date -Format "yyyyMMdd-HHmmss");New-Item -ItemType Directory -Force $bk|Out-Null
...
Write-Host "CLINICAL REASONING SAFETY EVIDENCE 42 COMPLETE" -ForegroundColor Green
Write-Host "Clinical reasoning, safety, and evidence layers integrated in place." -ForegroundColor Cyan
